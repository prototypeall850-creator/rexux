...
use rexux_extension_items::image_generation::ImageGenerationItem;
use rexux_protocol::items::parse_hook_prompt_message;
use rexux_protocol::protocol::AgentMessageEvent;
use rexux_protocol::protocol::AgentReasoningEvent;
use rexux_protocol::protocol::AgentReasoningRawContentEvent;
use rexux_protocol::protocol::AgentStatus;
use rexux_protocol::protocol::ApplyPatchApprovalRequestEvent;
use rexux_protocol::protocol::ContextCompactedEvent;
use rexux_protocol::protocol::DynamicToolCallResponseEvent;
use rexux_protocol::protocol::ErrorEvent;
use rexux_protocol::protocol::EventMsg;
use rexux_protocol::protocol::ExecCommandBeginEvent;
use rexux_protocol::protocol::ExecCommandEndEvent;
use rexux_protocol::protocol::GuardianAssessmentEvent;
use rexux_protocol::protocol::GuardianAssessmentStatus;
use rexux_protocol::protocol::ImageGenerationBeginEvent;
use rexux_protocol::protocol::ImageGenerationEndEvent;
use rexux_protocol::protocol::ItemCompletedEvent;
use rexux_protocol::protocol::ItemStartedEvent;
use rexux_protocol::protocol::McpToolCallBeginEvent;
use rexux_protocol::protocol::McpToolCallEndEvent;
use rexux_protocol::protocol::PatchApplyBeginEvent;
use rexux_protocol::protocol::PatchApplyEndEvent;
...
use rexux_protocol::protocol::ViewImageToolCallEvent;
use rexux_protocol::protocol::WebSearchBeginEvent;
use rexux_protocol::protocol::WebSearchEndEvent;
#[cfg(test)]
use rexux_protocol::review_format::REVIEW_FALLBACK_MESSAGE;
use rexux_rollout::CompactedItem;
...
#[cfg(test)]
use rexux_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
#[cfg(test)]
use rexux_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
...
impl ThreadHistoryBuilder {
    ...
    fn handle_response_item(&mut self, item: &rexux_protocol::models::ResponseItem) {
        let rexux_protocol::models::ResponseItem::Message {
            role, content, id, ..
        } = item
        else {
            return;
    ...
    fn handle_materialized_item_lifecycle(
        &mut self,
        turn_id: &str,
        item: &rexux_protocol::items::TurnItem,
    ) {
        let is_review_mode_item = matches!(
            item,
            rexux_protocol::items::TurnItem::EnteredReviewMode(_)
                | rexux_protocol::items::TurnItem::ExitedReviewMode(_)
        );
        let should_upsert = match item {
            rexux_protocol::items::TurnItem::Plan(plan) => !plan.text.is_empty(),
            rexux_protocol::items::TurnItem::HookPrompt(_)
            | rexux_protocol::items::TurnItem::FunctionCallOutput(_)
            | rexux_protocol::items::TurnItem::CommandExecution(_)
            | rexux_protocol::items::TurnItem::DynamicToolCall(_)
            | rexux_protocol::items::TurnItem::CollabAgentToolCall(_)
            | rexux_protocol::items::TurnItem::SubAgentActivity(_)
            | rexux_protocol::items::TurnItem::Extension(_)
            | rexux_protocol::items::TurnItem::EnteredReviewMode(_)
            | rexux_protocol::items::TurnItem::ExitedReviewMode(_) => true,
            rexux_protocol::items::TurnItem::UserMessage(_)
            | rexux_protocol::items::TurnItem::AgentMessage(_)
            | rexux_protocol::items::TurnItem::Reasoning(_)
            | rexux_protocol::items::TurnItem::WebSearch(_)
            | rexux_protocol::items::TurnItem::ImageView(_)
            | rexux_protocol::items::TurnItem::ImageGeneration(_)
            | rexux_protocol::items::TurnItem::FileChange(_)
            | rexux_protocol::items::TurnItem::McpToolCall(_)
            | rexux_protocol::items::TurnItem::ContextCompaction(_) => false,
        };
    ...
    fn handle_dynamic_tool_call_request(
        &mut self,
        payload: &rexux_protocol::dynamic_tools::DynamicToolCallRequest,
    ) {
    ...
    fn handle_collab_agent_spawn_begin(
        &mut self,
        payload: &rexux_protocol::protocol::CollabAgentSpawnBeginEvent,
    ) {
    ...
    fn handle_collab_agent_spawn_end(
        &mut self,
        payload: &rexux_protocol::protocol::CollabAgentSpawnEndEvent,
    ) {
    ...
    fn handle_collab_agent_interaction_begin(
        &mut self,
        payload: &rexux_protocol::protocol::CollabAgentInteractionBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_agent_interaction_end(
        &mut self,
        payload: &rexux_protocol::protocol::CollabAgentInteractionEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
    ...
    fn handle_sub_agent_activity(
        &mut self,
        payload: &rexux_protocol::protocol::SubAgentActivityEvent,
    ) {
    ...
    fn handle_collab_waiting_begin(
        &mut self,
        payload: &rexux_protocol::protocol::CollabWaitingBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_waiting_end(
        &mut self,
        payload: &rexux_protocol::protocol::CollabWaitingEndEvent,
    ) {
    ...
    fn handle_collab_close_begin(
        &mut self,
        payload: &rexux_protocol::protocol::CollabCloseBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_close_end(&mut self, payload: &rexux_protocol::protocol::CollabCloseEndEvent) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
        };
    ...
    fn handle_collab_resume_begin(
        &mut self,
        payload: &rexux_protocol::protocol::CollabResumeBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_end(
        &mut self,
        payload: &rexux_protocol::protocol::CollabResumeEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_entered_review_mode(
        &mut self,
        payload: &rexux_protocol::protocol::EnteredReviewModeEvent,
    ) {
        let review = payload
            .user_facing_hint
            .clone()
    ...
    fn handle_exited_review_mode(
        &mut self,
        payload: &rexux_protocol::protocol::ExitedReviewModeEvent,
    ) {
    ...
    fn handle_error(&mut self, payload: &ErrorEvent) {
        ...
        let changed_turn = if let Some(turn) = self.current_turn.as_mut() {
            ...
            turn.error = Some(V2TurnError {
                ...
                rexux_error_info: payload.rexux_error_info.clone().map(Into::into),
    ...
    fn handle_turn_complete(&mut self, payload: &TurnCompleteEvent) {
        let terminal_error = payload.error.as_ref().map(|error| V2TurnError {
            ...
            rexux_error_info: error.rexux_error_info.clone().map(Into::into),
            additional_details: None,
        });
...
fn convert_dynamic_tool_content_items(
    items: &[rexux_protocol::dynamic_tools::DynamicToolCallOutputContentItem],
) -> Vec<DynamicToolCallOutputContentItem> {
    items
        .iter()
        .cloned()
        .map(|item| match item {
            rexux_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputText { text } => {
                DynamicToolCallOutputContentItem::InputText { text }
            }
            rexux_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputImage {
                image_url,
            } => DynamicToolCallOutputContentItem::InputImage { image_url },
            rexux_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputAudio {
                audio_url,
...
mod tests {
    ...
    use rexux_extension_items::ExtensionItem as CoreExtensionItem;
    use rexux_extension_items::sleep::SleepItem as CoreSleepItem;
    use rexux_protocol::ThreadId;
    use rexux_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
    use rexux_protocol::items::CommandExecutionItem as CoreCommandExecutionItem;
    use rexux_protocol::items::CommandExecutionStatus as CoreCommandExecutionStatus;
    use rexux_protocol::items::EnteredReviewModeItem as CoreEnteredReviewModeItem;
    use rexux_protocol::items::ExitedReviewModeItem as CoreExitedReviewModeItem;
    use rexux_protocol::items::HookPromptFragment as CoreHookPromptFragment;
    use rexux_protocol::items::SubAgentActivityItem as CoreSubAgentActivityItem;
    use rexux_protocol::items::TurnItem as CoreTurnItem;
    use rexux_protocol::items::UserMessageItem as CoreUserMessageItem;
    use rexux_protocol::items::build_hook_prompt_message;
    use rexux_protocol::mcp::CallToolResult;
    use rexux_protocol::models::ImageDetail;
    use rexux_protocol::models::MessagePhase as CoreMessagePhase;
    use rexux_protocol::models::WebSearchAction as CoreWebSearchAction;
    use rexux_protocol::parse_command::ParsedCommand;
    use rexux_protocol::protocol::AgentReasoningEvent;
    use rexux_protocol::protocol::AgentReasoningRawContentEvent;
    use rexux_protocol::protocol::ApplyPatchApprovalRequestEvent;
    use rexux_protocol::protocol::RexuxErrorInfo;
    use rexux_protocol::protocol::DynamicToolCallResponseEvent;
    use rexux_protocol::protocol::EnteredReviewModeEvent;
    use rexux_protocol::protocol::ExecCommandBeginEvent;
    use rexux_protocol::protocol::ExecCommandEndEvent;
    use rexux_protocol::protocol::ExecCommandSource;
    use rexux_protocol::protocol::ExitedReviewModeEvent;
    use rexux_protocol::protocol::ItemStartedEvent;
    use rexux_protocol::protocol::McpInvocation;
    use rexux_protocol::protocol::McpToolCallEndEvent;
    use rexux_protocol::protocol::PatchApplyBeginEvent;
    use rexux_protocol::protocol::ReviewTarget;
    use rexux_protocol::protocol::SubAgentActivityKind as CoreSubAgentActivityKind;
    use rexux_protocol::protocol::ThreadRolledBackEvent;
        ...
        let events = vec![
            ...
            EventMsg::ItemStarted(ItemStartedEvent {
                ...
                item: CoreTurnItem::UserMessage(CoreUserMessageItem {
                    ...
                    content: vec![rexux_protocol::user_input::UserInput::Text {
                        text: "hello".into(),
                        text_elements: Vec::new(),
                    }],
                }),
    ...
    fn replays_image_generation_end_events_into_turn_history() {
        let items = vec![
            ...
            RolloutItem::EventMsg(EventMsg::ImageGenerationEnd(ImageGenerationEndEvent {
                ...
                transparent_background: Some(true),
                failure: Some(
                    rexux_extension_items::image_generation::ImageGenerationFailure::UsageLimitExceeded {
    ...
    fn reconstructs_dynamic_tool_items_from_request_and_response_events() {
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                rexux_protocol::dynamic_tools::DynamicToolCallRequest {
                    call_id: "dyn-1".into(),
                    turn_id: "turn-1".into(),
                    started_at_ms: 0,
                    namespace: Some("rexux_app".into()),
        ...
        let events = vec![
            ...
            EventMsg::PatchApplyEnd(PatchApplyEndEvent {
                ...
                changes: [(
                    ...
                    rexux_protocol::protocol::FileChange::Add {
                        content: "hello\n".into(),
                    },
                )]
                .into_iter()
        ...
        let events = vec![
            ...
            EventMsg::TurnComplete(TurnCompleteEvent {
                ...
                error: Some(ErrorEvent {
                    ...
                    rexux_error_info: Some(RexuxErrorInfo::ServerOverloaded),
                }),
                ...
                Turn {
                    ...
                    error: Some(TurnError {
                        ...
                        message: "Selected model is at capacity. Please try a different model."
                            .into(),
                        rexux_error_info: Some(
                            crate::protocol::v2::RexuxErrorInfo::ServerOverloaded,
                        ),
                        additional_details: None,
                    }),
                    started_at: Some(10),
    ...
    fn reconstructs_collab_resume_end_item() {
        let events = vec![
            ...
            EventMsg::CollabResumeEnd(rexux_protocol::protocol::CollabResumeEndEvent {
    ...
    fn reconstructs_collab_spawn_end_item_with_model_metadata() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentSpawnEnd(rexux_protocol::protocol::CollabAgentSpawnEndEvent {
                ...
                reasoning_effort: rexux_protocol::openai_models::ReasoningEffort::Medium,
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                reasoning_effort: Some(rexux_protocol::openai_models::ReasoningEffort::Medium),
                agents_states: [(
                    "00000000-0000-0000-0000-000000000002".into(),
                    CollabAgentState {
    ...
    fn reconstructs_interrupted_send_input_as_completed_collab_call() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentInteractionBegin(
                rexux_protocol::protocol::CollabAgentInteractionBeginEvent {
                    call_id: "send-1".into(),
                    started_at_ms: 0,
            ...
            EventMsg::CollabAgentInteractionEnd(
                rexux_protocol::protocol::CollabAgentInteractionEndEvent {
                    call_id: "send-1".into(),
                    completed_at_ms: 0,
                    sender_thread_id: sender,
                    receiver_thread_id: receiver,
    ...
    fn rollback_failed_error_does_not_mark_turn_failed() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                rexux_error_info: Some(RexuxErrorInfo::ThreadRollbackFailed),
            }),
        ];
    ...
    fn out_of_turn_error_does_not_create_or_fail_a_turn() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                rexux_error_info: Some(RexuxErrorInfo::BadRequest),
            }),
        ];
    ...
    fn error_then_turn_complete_preserves_failed_status() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                rexux_error_info: Some(RexuxErrorInfo::ResponseStreamDisconnected {
        ...
        assert_eq!(
            ...
            Some(TurnError {
                ...
                message: "stream failure".into(),
                rexux_error_info: Some(
                    crate::protocol::v2::RexuxErrorInfo::ResponseStreamDisconnected {
                        http_status_code: Some(502),
                    }
                ),
                additional_details: None,
        ...
        assert_eq!(
            ...
            vec![Turn {
                ...
                error: Some(TurnError {
                    misalignment: None,
                    message: "Selected model is at capacity. Please try a different model.".into(),
                    rexux_error_info: Some(crate::protocol::v2::RexuxErrorInfo::ServerOverloaded),
                    additional_details: None,
                }),
                started_at: Some(10),
                completed_at: Some(20),
    ...
    fn canonical_hook_prompt_completion_updates_turn_history() {
        let hook_prompt = CoreTurnItem::HookPrompt(rexux_protocol::items::HookPromptItem {
    ...
    fn completed_sub_agent_activity_updates_completed_parent_turn() {
        ...
        let child_path = rexux_protocol::AgentPath::root()
            .join("worker")
            .expect("worker path");
        let items = vec![
            RolloutItem::EventMsg(EventMsg::TurnStarted(TurnStartedEvent {
    ...
    fn ignores_plain_user_response_items_in_rollout_replay() {
        let items = vec![
            ...
            RolloutItem::ResponseItem(
                rexux_protocol::models::ResponseItem::Message {
                    id: Some(rexux_protocol::ResponseItemId::with_suffix("msg", "1")),
                    role: "user".into(),
                    content: vec![rexux_protocol::models::ContentItem::InputText {
