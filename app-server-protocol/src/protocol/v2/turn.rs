...
use rexux_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use rexux_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use rexux_protocol::turn_input::CyberAccessProgram as CoreCyberAccessProgram;
use rexux_protocol::user_input::ByteRange as CoreByteRange;
use rexux_protocol::user_input::TextElement as CoreTextElement;
...
/// Requested cyber treatment for a ChatGPT-authenticated Rexux turn.
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Rexux's ResponsesAPI turn metadata.
    ///
