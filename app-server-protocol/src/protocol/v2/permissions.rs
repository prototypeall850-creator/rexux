...
use crate::TS;
use rexux_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use rexux_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use rexux_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use rexux_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use rexux_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use rexux_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use rexux_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> rexux_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<rexux_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: rexux_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            rexux_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            rexux_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            rexux_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
