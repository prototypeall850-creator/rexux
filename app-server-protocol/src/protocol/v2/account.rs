...
use rexux_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use rexux_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use rexux_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use rexux_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use rexux_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum Account {
    ...
    AmazonBedrock {
        #[serde(default)]
        uses_rexux_managed_credentials: bool,
    },
}
    ...
    fn from(account: ProviderAccount) -> Self {
        match account {
            ...
            ProviderAccount::AmazonBedrock {
                uses_rexux_managed_credentials,
            } => Self::AmazonBedrock {
                uses_rexux_managed_credentials,
            },
        }
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Rexux-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Rexux attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Rexux attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Rexux was previously using.
    ///
