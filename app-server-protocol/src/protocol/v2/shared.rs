...
use rexux_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use rexux_protocol::config_types::SandboxMode as CoreSandboxMode;
...
use rexux_protocol::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
#[cfg(test)]
...
impl From<CoreRexuxErrorInfo> for RexuxErrorInfo {
    fn from(value: CoreRexuxErrorInfo) -> Self {
        match value {
            CoreRexuxErrorInfo::ContextWindowExceeded => RexuxErrorInfo::ContextWindowExceeded,
            CoreRexuxErrorInfo::SessionBudgetExceeded => RexuxErrorInfo::SessionBudgetExceeded,
            CoreRexuxErrorInfo::UsageLimitExceeded => RexuxErrorInfo::UsageLimitExceeded,
            CoreRexuxErrorInfo::RateLimitExceeded => RexuxErrorInfo::RateLimitExceeded,
            CoreRexuxErrorInfo::ServerOverloaded => RexuxErrorInfo::ServerOverloaded,
            CoreRexuxErrorInfo::CyberPolicy => RexuxErrorInfo::CyberPolicy,
            CoreRexuxErrorInfo::MisalignmentPolicyViolation => {
                RexuxErrorInfo::MisalignmentPolicyViolation
            }
            CoreRexuxErrorInfo::HttpConnectionFailed { http_status_code } => {
                RexuxErrorInfo::HttpConnectionFailed { http_status_code }
            }
            CoreRexuxErrorInfo::ResponseStreamConnectionFailed { http_status_code } => {
                RexuxErrorInfo::ResponseStreamConnectionFailed { http_status_code }
            }
            CoreRexuxErrorInfo::InternalServerError => RexuxErrorInfo::InternalServerError,
            CoreRexuxErrorInfo::Unauthorized => RexuxErrorInfo::Unauthorized,
            CoreRexuxErrorInfo::BadRequest => RexuxErrorInfo::BadRequest,
            CoreRexuxErrorInfo::ThreadRollbackFailed => RexuxErrorInfo::ThreadRollbackFailed,
            CoreRexuxErrorInfo::SandboxError => RexuxErrorInfo::SandboxError,
            CoreRexuxErrorInfo::ResponseStreamDisconnected { http_status_code } => {
                RexuxErrorInfo::ResponseStreamDisconnected { http_status_code }
            }
            CoreRexuxErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                RexuxErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CoreRexuxErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                RexuxErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CoreRexuxErrorInfo::Other => RexuxErrorInfo::Other,
        }
    }
}
