...
use rexux_protocol::protocol::MisalignmentErrorDetails as CoreMisalignmentErrorDetails;
use rexux_protocol::protocol::MisalignmentSteer as CoreMisalignmentSteer;
use rexux_protocol::protocol::SessionSource as CoreSessionSource;
use rexux_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use rexux_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. Rexux-generated thread IDs are UUIDv7.
    pub id: String,
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. Rexux-generated turn IDs are UUIDv7.
    pub id: String,
