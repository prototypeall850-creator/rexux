...
use rexux_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use rexux_protocol::protocol::TokenUsage as CoreTokenUsage;
use rexux_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "rexux_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. Rexux Cloud).
...
impl From<rexux_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: rexux_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> rexux_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => rexux_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => rexux_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `rexux_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
...
impl From<rexux_protocol::ResponseUsageMetadata> for ResponseUsageMetadata {
    fn from(value: rexux_protocol::ResponseUsageMetadata) -> Self {
        Self {
            amount: value.amount,
