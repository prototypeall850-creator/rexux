...
use rexux_experimental_api_macros::ExperimentalApi;
use rexux_extension_items::ExtensionItem;
pub use rexux_extension_items::image_generation::ImageGenerationFailure;
pub use rexux_extension_items::image_generation::ImageGenerationItem;
pub use rexux_extension_items::sleep::SleepItem;
pub use rexux_extension_items::web_search::WebSearchAction;
pub use rexux_extension_items::web_search::WebSearchItem;
use rexux_protocol::approvals::ExecApprovalKind as CoreExecApprovalKind;
use rexux_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use rexux_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use rexux_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use rexux_protocol::items::AgentMessageContent as CoreAgentMessageContent;
pub use rexux_protocol::items::AgentMessageDelivery;
pub use rexux_protocol::items::AsyncUserInputQuestion;
...
use rexux_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use rexux_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use rexux_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use rexux_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use rexux_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: rexux_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        rexux_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        rexux_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        rexux_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        rexux_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<rexux_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: rexux_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<rexux_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: rexux_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for rexux_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
