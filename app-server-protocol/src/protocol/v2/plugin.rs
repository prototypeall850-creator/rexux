...
use crate::TS;
use rexux_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use rexux_protocol::protocol::SkillInterface as CoreSkillInterface;
use rexux_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use rexux_protocol::protocol::SkillScope as CoreSkillScope;
use rexux_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Rexux app-server exposes `"AVAILABLE"` in its API; the alias keeps
