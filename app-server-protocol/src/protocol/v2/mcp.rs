...
use rexux_protocol::items::McpToolCallError as CoreMcpToolCallError;
use rexux_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use rexux_protocol::mcp::McpServerInfo;
use rexux_protocol::mcp::Resource as McpResource;
pub use rexux_protocol::mcp::ResourceContent as McpResourceContent;
use rexux_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use rexux_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from rexux_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from rexux_protocol::protocol::McpStartupFailureReason {
...
v2_enum_from_core!(
    ...
    pub enum McpServerConnectionStatus from rexux_protocol::mcp::McpServerConnectionStatus {
        NotStarted,
        Starting,
        Connected,
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> rexux_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => rexux_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => rexux_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => rexux_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Rexux turn when this elicitation was observed, if app-server could correlate one.
    ///
