...
pub use rexux_protocol::protocol::GitSha;
...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $REXUX_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [rexux_protocol::protocol::PatchApplyBeginEvent]
    /// and [rexux_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [rexux_protocol::protocol::ExecCommandBeginEvent]
    /// and [rexux_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
