...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Rexux.
    ApiKey,
    /// ChatGPT OAuth managed by Rexux (tokens persisted and refreshed by Rexux).
    Chatgpt,
    ...
    Headers,
    /// Programmatic Rexux auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic Rexux auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by Rexux.
    #[serde(rename = "bedrockApiKey")]
    #[ts(rename = "bedrockApiKey")]
    #[strum(serialize = "bedrockApiKey")]
    BedrockApiKey,
    /// Amazon Bedrock AWS access keys managed by Rexux.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by Rexux services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Rexux sandbox.
...
/// Superset of [`rexux_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Rexux Cloud.
...
mod tests {
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(rexux_protocol::protocol::W3cTraceContext {
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "rexux_apps".to_string(),
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    rexux_utils_path_uri::LegacyAppPathString::from_abs_path(&absolute_path(
                        "/tmp/AGENTS.md",
                    )),
                ],
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let rexux_managed_bedrock = v2::Account::AmazonBedrock {
            uses_rexux_managed_credentials: true,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesRexuxManagedCredentials": true,
            }),
            serde_json::to_value(&rexux_managed_bedrock)?,
        );
        ...
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesRexuxManagedCredentials": false,
            }),
    ...
    fn serialize_thread_realtime_start() -> Result<()> {
        let request = ClientRequest::ThreadRealtimeStart {
            ...
            params: v2::ThreadRealtimeStartParams {
                ...
                rexux_response_handoff_channel_prefixes: Some(std::collections::BTreeMap::from([
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: rexux_protocol::config_types::CollaborationMode {
                        mode: rexux_protocol::config_types::ModeKind::Default,
