...
use rexux_protocol::mcp::OPENAI_ELICITATION_EXTENSION_ID;
use rexux_protocol::mcp::OPENAI_FORM_EXTENSION_ID;
use rexux_protocol::mcp::OPENAI_STANDARD_FORM_INPUT_EXTENSION_ID;
use serde_json::Map;
use serde_json::Value;

/// Selects the MCP extensions Rexux supports from those declared by the app-server host.
///
/// App-server clients may declare unrelated extensions. Rexux retains only the
