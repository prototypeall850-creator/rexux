...
impl PreparedMcpCall {
    ...
    /// Returns whether this call is bound to the host-owned Rexux Apps server.
    ...
    /// this call's exact catalog revision and the extensions owned by the Rexux session.
