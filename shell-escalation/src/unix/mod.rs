...
//! `EscalateRequest` over the inherited `REXUX_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `REXUX_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use rexux_protocol::approvals::EscalationPermissions;
pub use rexux_protocol::approvals::ResolvedPermissionProfile;
