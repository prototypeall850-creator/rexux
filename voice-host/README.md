...
`rexux-voice-host` establishes the inherited-pipe lifecycle for the proposed
...
`rexux-resources/voice/bin/rexux-voice-host[.exe]`, filters the child environment,
and owns process cleanup through `rexux-utils-pty`. Its runtime must remain alive
