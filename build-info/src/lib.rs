//! Resolve the release identity of the current Rexux runtime.
...
impl BuildInfo {
    /// Return build information for the current Rexux runtime.
    pub fn get() -> Self {
        BUILD_INFO
    ...
    /// Format the version for a user-facing Rexux header.
