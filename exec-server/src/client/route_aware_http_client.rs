...
use rexux_protocol::shell_environment::OPENAI_WORKLOAD_IDENTITY_CONTEXT_ENV_VAR;
...
pub(crate) struct PendingRouteAwareHttpBodyStream {
    ...
    pub(crate) response: rexux_http_client::HttpResponse,
}
...
impl RouteAwareHttpRequestRunner {
    ...
    ) -> Result<(HttpRequestResponse, Option<PendingRouteAwareHttpBodyStream>), JSONRPCErrorError>
    {
        ...
        rexux_otel::inject_span_w3c_trace_headers(&request_span, &mut headers);
