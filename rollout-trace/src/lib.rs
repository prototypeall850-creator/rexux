//! Trace bundle format, writer, and reducer for Rexux rollouts.
//!
//! This crate owns the trace schema. Hot-path Rexux code should depend on the
...
/// Shared recorder context for inference attempts within one Rexux turn.
...
pub use thread::REXUX_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Rexux tool boundary.
...
/// Append-only writer used by hot-path Rexux instrumentation.
