...
/// Rexux conversation/session UUID.
...
/// Process/session ID returned by Rexux's terminal runtime.
...
/// Canonical reduced graph for one Rexux rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Rexux rollout/session being observed. `trace_id`
    ...
    pub rexux_turns: BTreeMap<RexuxTurnId, RexuxTurn>,
