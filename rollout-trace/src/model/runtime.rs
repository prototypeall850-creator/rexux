...
/// Runtime operation requested by the model, a JS code cell, or Rexux itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_rexux_turn_id: Option<RexuxTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Rexux tool boundary.
    ///
    ...
    /// they describe how Rexux executed the request, not what the caller sent.
