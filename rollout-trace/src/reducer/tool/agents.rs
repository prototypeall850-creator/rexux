...
use anyhow::Result;
use anyhow::bail;
use rexux_protocol::protocol::CollabAgentInteractionBeginEvent;
use rexux_protocol::protocol::CollabAgentInteractionEndEvent;
use rexux_protocol::protocol::CollabAgentSpawnEndEvent;
use rexux_protocol::protocol::CollabCloseBeginEvent;
use rexux_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_rexux_turn_id: String,
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.rexux_turn_id.as_deref() == Some(rexux_turn_id)
