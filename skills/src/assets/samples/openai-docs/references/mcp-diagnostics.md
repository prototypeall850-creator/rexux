...
3. When the current documentation supports it, the local Rexux CLI setup is:

   ```sh
   rexux mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp
   ```
