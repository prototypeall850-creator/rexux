...
use rexux_protocol::permissions::is_protected_metadata_name;
...
use rexux_protocol::protocol::FileSystemSpecialPath;
use rexux_protocol::protocol::WritableRoot;
        ...
        file_system_sandbox_policy
            ...
            .filter_map(|entry| {
                ...
                if project_subpath != Path::new(".git")
                    ...
                    && project_subpath != Path::new(".rexux")
                {
                    return None;
                }
...
mod tests {
    ...
    fn writable_roots_under_symlinked_ancestors_bind_real_target() {
        ...
        let logical_codex = logical_home.join(".rexux");
    ...
    fn missing_read_only_subpath_uses_empty_file_bind_data() {
        ...
        assert_empty_directory_mounted_read_only(&args.args, &workspace.join(".rexux"));
    ...
    fn missing_child_git_under_parent_repo_is_mounted_read_only() {
        ...
        assert_eq!(
            synthetic_mount_target_paths(&args),
            vec![workspace.join(".rexux"), dot_git, workspace.join(".agents")],
        );
        assert!(
    ...
    fn missing_project_root_metadata_carveouts_use_metadata_path_masks() {
        ...
        let dot_codex = path_to_string(&temp_dir.path().join(".rexux"));
