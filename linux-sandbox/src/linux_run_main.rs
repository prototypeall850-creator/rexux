...
) -> RexuxResult<crate::bwrap::BwrapArgs> {
...
fn exit_with_bwrap_build_error(err: rexux_protocol::error::RexuxErr) -> ! {
...
fn apply_inner_command_argv0_for_launcher(
    ...
    if supports_argv0 {
        argv.splice(
            ...
            ["--argv0".to_string(), REXUX_LINUX_SANDBOX_ARG0.to_string()],
        );
        return;
    }
...
fn preflight_proc_mount_support(network_mode: BwrapNetworkMode) -> RexuxResult<bool> {
