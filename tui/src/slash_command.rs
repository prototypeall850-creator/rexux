...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Rexux",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Rexux",
            ...
            SlashCommand::Skills => "use skills to improve how Rexux performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for Rexux",
            ...
            SlashCommand::Permissions => "choose what Rexux is allowed to do",
            ...
            SlashCommand::Logout => "log out of Rexux",
