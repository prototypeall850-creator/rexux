...
impl ChatWidget {
        ...
        match cmd {
            ...
            SlashCommand::Archive => {
                self.bottom_pane.show_selection_view(SelectionViewParams {
                    ...
                    subtitle: Some(
                        "Are you sure? This will archive the current session and exit Rexux"
                            .to_string(),
                    ),
    ...
    fn builtin_command_flags(&self) -> BuiltinCommandFlags {
        ...
        BuiltinCommandFlags {
            ...
            token_activity_command_enabled: self.has_rexux_backend_auth,
    ...
    fn ensure_usage_command_available(&mut self) -> bool {
        if self.has_rexux_backend_auth {
            return true;
        }
