...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: rexux_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, rexux_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                rexux_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                rexux_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                rexux_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                rexux_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                rexux_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                rexux_app_server_protocol::GuardianRiskLevel::Low => {
                    rexux_protocol::approvals::GuardianRiskLevel::Low
                }
                rexux_app_server_protocol::GuardianRiskLevel::Medium => {
                    rexux_protocol::approvals::GuardianRiskLevel::Medium
                }
                rexux_app_server_protocol::GuardianRiskLevel::High => {
                    rexux_protocol::approvals::GuardianRiskLevel::High
                }
                rexux_app_server_protocol::GuardianRiskLevel::Critical => {
                    rexux_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    rexux_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        rexux_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    rexux_app_server_protocol::GuardianUserAuthorization::Low => {
                        rexux_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    rexux_app_server_protocol::GuardianUserAuthorization::Medium => {
                        rexux_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    rexux_app_server_protocol::GuardianUserAuthorization::High => {
                        rexux_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                rexux_app_server_protocol::AutoReviewDecisionSource::Agent => {
