...
use rexux_otel::RuntimeMetricTotals;
...
async fn test_config() -> Config {
    let rexux_home = std::env::temp_dir();
...
fn mcp_tools_output_from_statuses_renders_status_only_servers() {
    let statuses = vec![McpServerStatus {
        ...
        auth_status: rexux_app_server_protocol::McpAuthStatus::Unknown,
    }];
