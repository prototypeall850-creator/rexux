...
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Rexux.";
const FREE_GO_TOOLTIP: &str =
    "*New* For a limited time, Rexux is included in your plan for free – let’s build together.";
...
/// Pick a random tooltip to show to the user when starting Rexux.
...
pub(crate) mod announcement {
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Rexux currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
    ...
    pub(crate) fn parse_announcement_tip_toml(
        ...
        for raw in announcements {
            ...
            if tip.version_matches(REXUX_CLI_VERSION)
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Rexux TUI.
...
[[announcements]]
content = "Welcome to Rexux! Check out the new onboarding flow."
