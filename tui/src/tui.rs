...
/// Restore the terminal after Rexux is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let scrollback = ScrollbackStrategy::detect(&rexux_terminal_detection::terminal_info());
    ...
    /// terminal modes and stderr while keeping raw mode enabled, then re-applies Rexux TUI modes
