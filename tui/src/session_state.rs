...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: rexux_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<rexux_protocol::openai_models::ReasoningEffort>,
