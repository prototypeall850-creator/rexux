...
use rexux_app_server_protocol::FileSystemAccessMode;
use rexux_app_server_protocol::FileSystemPath;
use rexux_app_server_protocol::FileSystemSandboxEntry;
use rexux_app_server_protocol::FileSystemSpecialPath;
use rexux_app_server_protocol::McpServerElicitationAction;
use rexux_app_server_protocol::NetworkApprovalContext;
use rexux_app_server_protocol::NetworkApprovalProtocol;
    ...
    available_decisions
        ...
        .filter_map(|decision| match decision {
            ...
            CommandExecutionApprovalDecision::Cancel => Some(ApprovalOption {
                label: "No, and tell Rexux what to do differently".to_string(),
...
mod tests {
    ...
    use rexux_app_server_protocol::ExecPolicyAmendment;
    use rexux_app_server_protocol::NetworkApprovalProtocol;
    use rexux_app_server_protocol::NetworkPolicyAmendment;
    use rexux_config::types::KeybindingSpec;
    use rexux_config::types::KeybindingsSpec;
    ...
    fn network_exec_options_use_expected_labels_and_hide_execpolicy_amendment() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "Yes, and allow this host for this conversation".to_string(),
                "Yes, and allow this host in the future".to_string(),
                "No, and tell Rexux what to do differently".to_string(),
            ]
        );
    }
