...
pub(crate) enum StatusLineItem {
    ...
    /// Hostname of the machine running Rexux.
    Hostname,
...
impl StatusLineItem {
    ...
    pub(crate) fn description(self) -> &'static str {
        match self {
            ...
            StatusLineItem::RexuxVersion => "Rexux application version",
    ...
    pub(crate) fn preview_item(self) -> StatusSurfacePreviewItem {
        match self {
            ...
            StatusLineItem::RexuxVersion => StatusSurfacePreviewItem::RexuxVersion,
