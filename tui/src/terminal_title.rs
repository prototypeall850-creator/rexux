...
//! "leave the old title alone" or "clear the title Rexux last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Rexux manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Rexux started managing the title.
