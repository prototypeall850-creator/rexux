...
impl App {
    ...
    pub async fn run(
        ...
        let has_rexux_backend_auth = matches!(auth_mode, Some(TelemetryAuthMode::Chatgpt));
        ...
        let session_telemetry = SessionTelemetry::new(
            ...
            auth_mode,
            rexux_login::default_client::originator().value,
...
See the Rexux keymap documentation for supported actions and examples."
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            if should_check {
                ...
                let logs_base_dir = app.config.rexux_home.clone();
