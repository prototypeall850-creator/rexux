        ...
        match event {
            ...
            AppEvent::BeginWindowsSandboxElevatedSetup {
                ...
                #[cfg(target_os = "windows")]
                {
                    ...
                    if crate::windows_sandbox::sandbox_setup_is_complete(rexux_home.as_path()) {
                ...
                #[cfg(target_os = "windows")]
                {
                    ...
                    .await
                    {
                        ...
                        Ok(_) => {
                            ...
                            {
                                self.app_event_tx.send(AppEvent::RexuxOp(
                                ...
                                self.chat_widget.add_plain_history_lines(vec![
                                    ...
                                    Line::from(vec![
                                        "  ".into(),
                                        "Rexux can now safely edit files and execute commands in your computer"
                                            .dark_gray(),
                                    ]),
                                ]);
                            } else {
                ...
                #[cfg(target_os = "windows")]
                {
                    ...
                    if should_check {
                        ...
                        let env_map: std::collections::HashMap<String, String> =
                            std::env::vars().collect();
                        let tx = self.app_event_tx.clone();
                        let logs_base_dir = self.config.rexux_home.clone();
