...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Rexux is rebuilding normal terminal scrollback, not an
...
use rexux_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
