...
fn consecutive_unordered_list_local_file_links_do_not_detach_paths() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            "- expectations (codex-rs/core/README.md:1): rexux-core owns the real",
            "  runtime behavior.",
        ]
    );
}
...
| --- | --- | --- |
| [2026-05-25 current gallery](/Users/felipe.coury/.rexux/sessions/2026/05/25/rollout-2026-05-25T18-13-09-019e60fc-0518-7c21-9596-980fe97225ba.jsonl) | The large gallery from this thread: emojis, links, emphasis, code, alignment, paragraphs, and a 30+ row table | 7 |
| [2026-05-14 renderer testing](/Users/felipe.coury/.rexux/sessions/2026/05/14/rollout-2026-05-14T12-57-18-019e2734-e500-7011-8278-975c94d06000.jsonl) | Explicit "markdown tables for testing" session with several successive assistant samples | 16 |
| [2026-05-14 five-table test](/Users/felipe.coury/.rexux/sessions/2026/05/14/rollout-2026-05-14T12-27-57-019e271a-064c-78c3-a5cd-a6f20a0c1ad5.jsonl) | Explicit request for five tables containing emojis, code, italics, and varied cell content | 10 |
"#;
...
| [#23651: Zellij scrollback misses Rexux transcript over SSH](https://github.com/openai/codex/issues/23651) | `+1` 3, human comments 2 | Medium | Clear regression and strong scrollback evidence. |
