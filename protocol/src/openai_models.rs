//! Shared model metadata types exchanged between Rexux services and clients.
//!
...
/// Metadata describing a Rexux-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Rexux backend `/models` endpoint.
