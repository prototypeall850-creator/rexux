...
pub const REXUX_SESSION_ID_ENV_VAR: &str = "REXUX_SESSION_ID";
pub const REXUX_THREAD_ID_ENV_VAR: &str = "REXUX_THREAD_ID";
pub const REXUX_EXEC_SERVER_NOISE_AUTH_TOKEN_ENV_VAR: &str = "REXUX_EXEC_SERVER_NOISE_AUTH_TOKEN";
...
///
/// This prevents accidental propagation of Rexux launch context; it is not a
    ...
    I: IntoIterator<Item = (String, String)>,
{
    ...
    if let Some(thread_id) = thread_id {
        env_map.insert(REXUX_THREAD_ID_ENV_VAR.to_string(), thread_id.to_string());
    }
