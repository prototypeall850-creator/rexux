...
fn private_desktop_rejects_interactive_and_injected_names() {
    for name in [
        ...
        r"Winsta0\Default",
        "RexuxSandboxDesktop-",
        r"RexuxSandboxDesktop-abcd\Default",
        "RexuxSandboxDesktop-abcd\0Default",
        "RexuxSandboxDesktop-0123456789abcdef0123456789abcdef0",
    ] {
...
fn legacy_desktop_reuses_only_equivalent_permissions() -> Result<()> {
    ...
    let security = prepare_legacy_session_security(
        ...
        &rexux_home,
        &workspace,
        legacy_session_capability_roots(&permissions, &workspace, &env, &rexux_home),
    )?;
