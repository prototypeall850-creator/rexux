...
const SESSION_NAME: &str = "Rexux Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Rexux Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Rexux Windows sandbox filters";
const SUBLAYER_NAME: &str = "Rexux Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Rexux Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Rexux-owned identities; do not regenerate them unless we
...
/// Installs the persistent Rexux WFP filters for `account`.
///
...
/// Ensures the persistent Rexux WFP provider exists.
...
/// Ensures the persistent Rexux sublayer exists under the Rexux provider.
