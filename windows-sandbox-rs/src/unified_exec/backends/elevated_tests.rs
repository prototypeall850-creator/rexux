...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        rexux_home: PathBuf::from(r"C:\Users\codex"),
        ...
        spawn_request: SpawnRequest {
            ...
            rexux_home: PathBuf::from(r"C:\Users\codex\.sandbox"),
            real_rexux_home: PathBuf::from(r"C:\Users\codex"),
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        rexux_home: request.rexux_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |rexux_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
