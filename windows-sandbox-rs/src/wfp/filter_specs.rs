...
pub(super) const FILTER_SPECS: &[FilterSpec] = &[
    FilterSpec {
        ...
        name: "rexux_wfp_icmp_connect_v4",
    ...
    FilterSpec {
        ...
        name: "rexux_wfp_icmp_connect_v6",
