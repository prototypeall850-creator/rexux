...
const SETUP_BIN: &str = "rexux-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "rexux-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Rexux binaries that link the
