...
use rexux_protocol::openai_models::ApprovalMessages;
...
use rexux_protocol::openai_models::MultiAgentModeMessages;
use rexux_protocol::openai_models::MultiAgentRoleMessages;
use rexux_protocol::openai_models::PermissionMessages;
...
fn disabled_personality_uses_plain_base_instructions_for_local_personality_models() {
    ...
    for slug in ["gpt-5.2-codex", "exp-rexux-personality"] {
