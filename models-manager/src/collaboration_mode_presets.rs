use rexux_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use rexux_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use rexux_protocol::config_types::CollaborationModeMask;
use rexux_protocol::config_types::ModeKind;
use rexux_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
