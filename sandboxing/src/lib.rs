...
pub use rexux_windows_sandbox::WindowsSandboxProxySettingsMode;
...
pub fn system_bwrap_warning(
    _permission_profile: &rexux_protocol::models::PermissionProfile,
) -> Option<String> {
    None
}

impl From<SandboxTransformError> for RexuxErr {
    fn from(err: SandboxTransformError) -> Self {
        match err {
            ...
            SandboxTransformError::MissingLinuxSandboxExecutable => {
                RexuxErr::LandlockSandboxExecutableNotProvided
            }
            SandboxTransformError::EnvironmentNetworkProxy(message) => {
                RexuxErr::UnsupportedOperation(message)
            }
            #[cfg(target_os = "macos")]
            ...
            SandboxTransformError::Wsl1UnsupportedForBubblewrap => {
                RexuxErr::UnsupportedOperation(crate::bwrap::WSL1_BWRAP_WARNING.to_string())
            }
            #[cfg(not(target_os = "macos"))]
            SandboxTransformError::SeatbeltUnavailable => RexuxErr::UnsupportedOperation(
