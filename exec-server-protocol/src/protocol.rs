...
pub use rexux_file_system::WalkOptions;
pub use rexux_file_system::WalkOutcome;
...
use rexux_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        ...
        Self {
            shell: rexux_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `rexux-linux-sandbox` are command
...
mod tests {
    ...
    use rexux_network_proxy::RemoteNetworkProxyLaunchConfig;
    use rexux_protocol::config_types::WindowsSandboxProxySettingsMode;
