pub(crate) const OTEL_TARGET_PREFIX: &str = "rexux_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "rexux_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "rexux_otel.trace_safe";
