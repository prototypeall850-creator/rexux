...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        rexux_app_server_protocol::TurnCompletedNotification {
            ...
            turn: rexux_app_server_protocol::Turn {
                ...
                error: Some(rexux_app_server_protocol::TurnError {
                    misalignment: None,
    ...
    assert_eq!(status, RexuxStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        rexux_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "OpenAI Rexux CLI documentation"}]}),
                app_context: None,
