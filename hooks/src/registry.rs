...
impl Hooks {
    ...
    ) -> anyhow::Result<(Self, Receiver<rexux_protocol::protocol::HookCompletedEvent>)> {
    ...
    ) -> Vec<rexux_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_session_end(&self) -> Vec<rexux_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_interrupt(&self) -> Vec<rexux_protocol::protocol::HookRunSummary> {
