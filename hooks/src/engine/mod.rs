...
use rexux_protocol::protocol::HookTrustStatus;
...
pub(crate) struct ConfiguredHandler {
    ...
    pub builtin: bool,
    pub event_name: rexux_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            rexux_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            rexux_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            rexux_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            rexux_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            rexux_protocol::protocol::HookEventName::PostCompact => "post-compact",
            rexux_protocol::protocol::HookEventName::SessionStart => "session-start",
            rexux_protocol::protocol::HookEventName::SessionEnd => "session-end",
            rexux_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            rexux_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            rexux_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            rexux_protocol::protocol::HookEventName::Stop => "stop",
            rexux_protocol::protocol::HookEventName::Interrupt => "interrupt",
        }
    }
