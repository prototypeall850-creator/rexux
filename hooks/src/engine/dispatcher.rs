...
pub(crate) fn completed_summary(
    ...
    entries: Vec<rexux_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    let HandlerSourcePath::Local(source_path) = &handler.source_path else {
        unreachable!("executor-scoped hooks do not produce public hook summaries");
    };
...
pub(crate) fn hook_source_label(source: rexux_protocol::protocol::HookSource) -> &'static str {
    match source {
        rexux_protocol::protocol::HookSource::System => "system",
        rexux_protocol::protocol::HookSource::User => "user",
        rexux_protocol::protocol::HookSource::Project => "project",
        rexux_protocol::protocol::HookSource::Mdm => "mdm",
        rexux_protocol::protocol::HookSource::SessionFlags => "session_flags",
        rexux_protocol::protocol::HookSource::Plugin => "plugin",
        rexux_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        rexux_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        rexux_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        rexux_protocol::protocol::HookSource::LegacyManagedConfigMdm => "legacy_managed_config_mdm",
        rexux_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
