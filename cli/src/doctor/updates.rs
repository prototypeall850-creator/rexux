//! Diagnoses whether Rexux update paths target the running installation.
//!
...
const DESKTOP_UPDATE_URL: &str = "https://persistent.oaistatic.com/rexux-app-prod/appcast-x64.xml";
#[cfg(all(target_os = "macos", not(target_arch = "x86_64")))]
const DESKTOP_UPDATE_URL: &str = "https://persistent.oaistatic.com/rexux-app-prod/appcast.xml";
#[cfg(target_os = "macos")]
const BACKEND_DESKTOP_UPDATE_URL: &str = "https://chatgpt.com/backend-api/wham/app/appcast";
#[cfg(target_os = "windows")]
const DESKTOP_UPDATE_URL: &str =
    "https://persistent.oaistatic.com/rexux-app-prod/windows-store-update.json";
...
pub(super) fn updates_check(config: &Config) -> DoctorCheck {
    ...
    let version_file = config.rexux_home.join(VERSION_FILE_NAME);
...
fn windows_store_update(
    ...
    if manifest.schema_version == 0
        ...
        || manifest.package_identity != "OpenAI.Rexux"
    {
