//! Captures how this Rexux process was launched.
//!
...
/// Builds the process provenance row for the current Rexux executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Rexux package.");
    }
    check
}
