...
use rexux_git_utils::get_git_remote_urls_assume_git_repo;
use rexux_git_utils::get_has_changes_in_repo;
use rexux_git_utils::get_head_commit_hash;
...
pub async fn detached_memory_responses_metadata(
    ...
    let mut metadata = RexuxResponsesMetadata {
        request_kind: Some(RexuxResponsesRequestKind::Memory),
        ...
        .await,
        ..RexuxResponsesMetadata::new(installation_id, session_id, thread_id, window_id)
    };
...
impl rexux_analytics::TurnAnalyticsMetadata for TurnMetadataState {
...
impl TurnMetadataState {
    ...
    fn responses_metadata_template(&self) -> RexuxResponsesMetadata {
    ...
    fn mcp_metadata_template(&self) -> RexuxResponsesMetadata {
        let mut extra = self
            .responsesapi_client_metadata
            .read()
            .unwrap_or_else(std::sync::PoisonError::into_inner)
