...
/// Start an interactive sub-Rexux thread and return its runtime and IO channels.
///
...
pub(crate) async fn run_rexux_thread_interactive(
    mut config: Config,
...
#[allow(clippy::too_many_arguments)]
pub(crate) async fn run_rexux_thread_one_shot(
    config: Config,
    auth_manager: Arc<AuthManager>,
    models_manager: SharedModelsManager,
    input: Vec<UserInput>,
