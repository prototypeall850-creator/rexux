...
use rexux_models_manager::collaboration_mode_presets;
...
pub fn auth_manager_from_auth(auth: RexuxAuth) -> Arc<AuthManager> {
    AuthManager::from_auth_for_testing(auth)
}

pub fn auth_manager_from_auth_with_home(auth: RexuxAuth, rexux_home: PathBuf) -> Arc<AuthManager> {
    AuthManager::from_auth_for_testing_with_home(auth, rexux_home)
}
...
) -> rexux_protocol::error::Result<crate::NewThread> {
    thread_manager
...
pub fn models_manager_with_provider(
    ...
    provider.models_manager(rexux_home, /*config_model_catalog*/ None)
}
...
#[derive(Clone, Copy)]
pub enum TestRexuxResponsesRequestKind {
    Turn,
    Prewarm,
    WebsocketConnection,
}
...
pub fn responses_metadata(
    ...
    let request_kind = match request_kind {
        TestRexuxResponsesRequestKind::Turn => Some(RexuxResponsesRequestKind::Turn),
        TestRexuxResponsesRequestKind::Prewarm => Some(RexuxResponsesRequestKind::Prewarm),
        TestRexuxResponsesRequestKind::WebsocketConnection => None,
    };
    RexuxResponsesMetadata {
...
pub fn with_parent_turn(mut metadata: RexuxResponsesMetadata, id: &str) -> RexuxResponsesMetadata {
