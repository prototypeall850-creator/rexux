...
//!
//! `rexux-rollout-trace` owns the event schema and writer behavior. This module
...
use rexux_rollout_trace::ToolDispatchInvocation;
use rexux_rollout_trace::ToolDispatchPayload;
use rexux_rollout_trace::ToolDispatchRequester;
use rexux_rollout_trace::ToolDispatchResult;
use rexux_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        rexux_turn_id: invocation.turn.sub_id.clone(),
