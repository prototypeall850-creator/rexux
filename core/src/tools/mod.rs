...
) -> rexux_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => rexux_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => rexux_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => rexux_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => rexux_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => rexux_tools::ToolUserShellType::Cmd,
    }
}
