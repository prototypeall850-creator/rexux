...
use rexux_analytics::ArtifactOperation;
use rexux_analytics::ArtifactOperationLifecycle;
use rexux_analytics::build_track_events_context;
use rexux_apply_patch::AppliedPatchDelta;
use rexux_core_plugins::PluginCommandAttribution;
use rexux_core_plugins::recognize_artifact_operation;
use rexux_otel::ARTIFACT_OPERATION_EXPECTED_OUTPUT_COUNT_METRIC;
use rexux_otel::ARTIFACT_OPERATION_STARTED_METRIC;
...
use rexux_protocol::items::CommandExecutionStatus;
...
impl ToolEmitter {
    ...
    pub async fn finish(
        ...
        let (event, result) = match out {
            ...
            Err(ToolError::Rexux(err)) => match err.details() {
...
mod tests {
    ...
    async fn assert_failed_apply_patch_tracks_committed_delta(
        ...
        let delta = rexux_apply_patch::apply_patch(
    ...
    async fn denied_apply_patch_tracks_committed_delta() {
        ...
        assert_failed_apply_patch_tracks_committed_delta(
            Err(ToolError::Rexux(RexuxErr::Sandbox(SandboxErr::Denied {
