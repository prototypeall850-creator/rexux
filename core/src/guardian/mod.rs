...
pub(crate) const AUTO_REVIEW_DENIED_ACTION_APPROVAL_DEVELOPER_PREFIX: &str =
    rexux_guardian_context::MANUAL_APPROVAL_DEVELOPER_PREFIX;
...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: rexux_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: rexux_protocol::protocol::GuardianUserAuthorization,
