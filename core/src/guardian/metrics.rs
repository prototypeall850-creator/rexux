...
use rexux_otel::GUARDIAN_REVIEW_COUNT_METRIC;
use rexux_otel::GUARDIAN_REVIEW_DURATION_METRIC;
use rexux_otel::GUARDIAN_REVIEW_TOKEN_USAGE_METRIC;
use rexux_otel::GUARDIAN_REVIEW_TTFT_DURATION_METRIC;
...
mod tests {
    ...
    #[test_case(
        GuardianReviewedAction::NetworkAccess {
            protocol: rexux_protocol::approvals::NetworkApprovalProtocol::Https,
            port: 443,
        },
        "network_access",
        BTreeMap::new();
    ...
    #[test_case(
        GuardianReviewedAction::McpToolCall {
            server: "rexux_apps_custom".to_string(),
