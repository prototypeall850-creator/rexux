//! Omits checklist-tool guidance from Rexux-owned prompts, before adding caller text.

/// Call only for Rexux-owned prompt text; custom instructions must remain unchanged.
