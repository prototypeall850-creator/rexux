...
/// `rexux_feedback::RexuxFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// rexux_core::feedback_tags!(model = "gpt-5", cached = true);
/// rexux_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
