...
//! inputs and the mutable [`rexux_mcp::McpRuntime`]. Background scheduling
//! belongs elsewhere.
...
pub(super) struct McpDesiredState {
    ...
    pub(super) auth: Option<RexuxAuth>,
...
impl Session {
        ...
        Box::pin(async move {
            ...
            for selected in environments.turn_environments() {
                ...
                for (name, mut server) in servers {
                    ...
                    if name == REXUX_APPS_MCP_SERVER_NAME
                    ...
                    catalog.build_with_environment_authority(|environment_id| {
                        let Some(selection) = selections
                            ...
                            return if environment_id
                                == rexux_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID
                            {
    ...
    pub(super) fn build_mcp_runtime_input(
        ...
        config
            .environment_cwds
            .entry(rexux_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID.to_string())
        ...
        McpRuntimeInput {
            ...
            runtime_context,
            rexux_apps_tools_cache: self.services.mcp_manager.rexux_apps_tools_cache(),
