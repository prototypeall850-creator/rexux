...
pub(crate) struct Session {
    ...
    pub(super) mcp_elicitation_reviewer_handle: OnceLock<rexux_mcp::ElicitationReviewerHandle>,
    pub(super) mcp_elicitation_lifecycle_handle: OnceLock<rexux_mcp::ElicitationLifecycle>,
...
pub(crate) struct SessionConfiguration {
    ...
    /// Directory containing all Rexux state for this session.
    pub(super) rexux_home: AbsolutePathBuf,
...
impl SessionConfiguration {
    ...
    pub(crate) fn rexux_home(&self) -> &AbsolutePathBuf {
        &self.rexux_home
    }
    ...
    pub(super) fn thread_config_snapshot(
        ...
        ThreadConfigSnapshot {
            ...
            full_access: rexux_protocol::protocol::has_full_access(
            ...
            if let Some(active_permission_profile) = next_configuration.active_permission_profile()
            {
                ...
                config.permissions.network = config
                    ...
                    .map_err(|err| ConstraintError::InvalidValue {
                        ...
                        requirement_source: rexux_config::RequirementSource::Unknown,
                    })?;
                config
                    .permissions
...
async fn warm_plugins_and_skills_for_session_init(
    ...
    extensions: &rexux_extension_api::ExtensionRegistry<Config>,
) -> Vec<SkillError> {
...
impl Session {
    ...
    pub(crate) async fn responses_metadata(
        ...
        request_kind: RexuxResponsesRequestKind,
    ...
    pub(crate) async fn new(
        ...
        environment_selections: &[TurnEnvironmentSelection],
        config: Arc<Config>,
        user_instructions: Option<rexux_extension_api::Instructions>,
        ...
        code_mode_session_provider: Arc<dyn rexux_code_mode::CodeModeSessionProvider>,
        extensions: Arc<rexux_extension_api::ExtensionRegistry<crate::config::Config>>,
        ...
        windows_sandbox_proxy_settings_mode: rexux_sandboxing::WindowsSandboxProxySettingsMode,
            ...
            ForkPersistence::Copied => match &initial_history {
                InitialHistory::Resumed(resumed) => {
                    ...
                    resumed.history.first().and_then(|item| match item {
                        ...
                        {
                            rexux_rollout::forked_from_ordinal_exclusive(
                                &meta.meta,
        ...
        thread_extension_init.insert(rexux_extension_api::ThreadOriginator(
            session_configuration.originator.clone(),
        ));
        let mcp_thread_init = thread_extension_init.clone();
        let thread_extension_data = rexux_extension_api::ExtensionData::new_with_init(
            thread_id.to_string(),
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let config_path = config.rexux_home.join(CONFIG_TOML_FILE);
            ...
            let auth_mode = telemetry_auth
                .map(RexuxAuth::auth_mode)
                .map(TelemetryAuthMode::from);
            let account_id = telemetry_auth.and_then(RexuxAuth::get_account_id);
            let account_email = telemetry_auth.and_then(RexuxAuth::get_account_email);
            ...
            let auth_env_telemetry = collect_auth_env_telemetry(
                ...
                auth_manager.rexux_api_key_env_enabled(),
            );
            ...
            let mcp_server_names =
                rexux_mcp::effective_mcp_servers(
            ...
            let session_extension_data =
                rexux_extension_api::ExtensionData::new(session_id.to_string());
            ...
            for contributor in extensions.thread_lifecycle_contributors() {
                contributor.on_thread_start(rexux_extension_api::ThreadStartInput {
            ...
            let session_start_source = match &initial_history {
                InitialHistory::Resumed(_) => rexux_hooks::SessionStartSource::Resume,
                InitialHistory::New | InitialHistory::Forked(_) => {
                    rexux_hooks::SessionStartSource::Startup
                }
                InitialHistory::Cleared => rexux_hooks::SessionStartSource::Clear,
            };
