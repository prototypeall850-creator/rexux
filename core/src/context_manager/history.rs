...
use rexux_guardian_context::TranscriptHistory;
use rexux_history::RexuxHarnessMetadata;
use rexux_history::GuardianHistoryCheckpoint;
...
use rexux_utils_audio::estimate_audio_token_count;
use rexux_utils_cache::BlockingLruCache;
use rexux_utils_cache::sha1_digest;
...
use rexux_utils_output_truncation::approx_tokens_from_byte_count_i64;
use rexux_utils_output_truncation::truncate_function_output_payload;
...
impl ContextManager {
    ...
    where
        I: IntoIterator<Item = (T, Option<&'a RexuxHarnessMetadata>)>,
