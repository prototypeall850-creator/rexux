...
use rexux_connectors::PluginConnectorSource;
...
use rexux_extension_api::SelectedPluginIdentity;
use rexux_extension_api::SelectedPluginSnapshot;
...
use rexux_mcp::McpEnvironmentAuthority;
...
use rexux_mcp::rexux_apps_mcp_server_config;
use rexux_mcp::configured_mcp_servers;
...
const LEGACY_REXUX_APPS_REGISTRATION_ID: &str = "legacy_rexux_apps";
...
impl McpManager {
    pub fn new(plugins_manager: Arc<PluginsManager>) -> Self {
        Self::new_with_extensions(
            plugins_manager,
            rexux_extension_api::empty_extension_registry(),
    ...
    pub fn rexux_apps_tools_cache(&self) -> ConnectorRuntimeManager<ToolInfo> {
        self.rexux_apps_tools_cache.clone()
    }
    ...
    async fn runtime_config_with_context(
        ...
        if mcp_config.apps_enabled {
            catalog.register(McpServerRegistration::from_compatibility(
                ...
                LEGACY_REXUX_APPS_REGISTRATION_ID,
