...
use rexux_config::default_project_root_markers;
use rexux_config::merge_toml_values;
use rexux_config::project_root_markers_from_config;
...
impl LoadedAgentsMd {
    ...
    /// compile `rexux-core` as a normal dependency without that configuration.
