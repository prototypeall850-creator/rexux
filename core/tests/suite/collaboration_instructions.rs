...
use rexux_protocol::openai_models::CollaborationModeMessages;
use rexux_protocol::openai_models::ModelMessages;
use rexux_protocol::openai_models::ModelsResponse;
use rexux_protocol::protocol::COLLABORATION_MODE_CLOSE_TAG;
...
fn model_with_collaboration_messages(
    ...
    default: Option<&str>,
    plan: Option<&str>,
) -> rexux_protocol::openai_models::ModelInfo {
            ...
            .with_thread_settings(ThreadSettingsOverrides {
                ...
                summary: Some(
                    test.config
                        ...
                        .unwrap_or(rexux_protocol::config_types::ReasoningSummary::Auto),
                ),
                collaboration_mode: Some(collaboration_mode),
                ..Default::default()
            }),
...
async fn cold_resume_refreshes_legacy_collaboration_snapshot_once(
    ...
    let builder_with_instructions = |instructions: &str| {
        ...
        test_rexux().with_model(MODEL).with_config(move |config| {
            config.model_catalog = Some(ModelsResponse {
                models: vec![model],
            });
        })
