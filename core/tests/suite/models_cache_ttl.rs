...
use rexux_models_manager::client_version_to_whole;
...
const REMOTE_MODEL: &str = "rexux-test-ttl";
const VERSIONED_MODEL: &str = "rexux-test-versioned";
const MISSING_VERSION_MODEL: &str = "rexux-test-missing-version";
const DIFFERENT_VERSION_MODEL: &str = "rexux-test-different-version";
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    let cache_path = config.rexux_home.join(CACHE_FILE);
    ...
    codex
        .start_or_steer_turn(
            ...
            .with_thread_settings(ThreadSettingsOverrides {
                ...
                approval_policy: Some(rexux_protocol::protocol::AskForApproval::Never),
...
async fn matching_models_etag_does_not_rewrite_recent_cache() -> Result<()> {
    ...
    let cache_path = test.config.rexux_home.join(CACHE_FILE);
