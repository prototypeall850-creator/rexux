...
// It allows the test binary to behave like codex and dispatch to apply_patch and rexux-linux-sandbox
// based on the arg0.
// NOTE: this doesn't work on ARM
#[ctor]
pub static REXUX_ALIASES_TEMP_DIR: Option<TestBinaryDispatchGuard> = {
    configure_test_binary_dispatch("rexux-core-tests", |exe_name, argv1| {
        if argv1 == Some(REXUX_CORE_APPLY_PATCH_ARG1) {
