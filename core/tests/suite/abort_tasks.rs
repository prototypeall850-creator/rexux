...
use rexux_core::SuspendTurnOutcome;
...
async fn root_turn_suspension_preserves_unfinished_turn_history() {
    ...
    let rexux_core::TurnInputSubmission::Started { turn_id } = submitted else {
    ...
    assert_eq!(
        resumed
            .codex
            .recover_turn_if_idle(rexux_core::RecoverTurnRequest {
                turn_id: turn_id.clone(),
        ...
        rexux_core::StartIfIdleSubmission::Started {
            turn_id: turn_id.clone(),
        },
    );
