...
async fn submit_user_turn(codex: &Arc<RexuxThread>, text: &str) -> Result<()> {
    codex
...
async fn submit_compact_turn(codex: &Arc<RexuxThread>) -> Result<()> {
...
async fn shutdown_thread(codex: &Arc<RexuxThread>) -> Result<()> {
