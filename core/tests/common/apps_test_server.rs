use crate::test_rexux::TestRexuxBuilder;
use crate::test_rexux::test_rexux;
use anyhow::Result;
...
const REXUX_APPS_META_KEY: &str = "_rexux_apps";
const REXUX_APPS_MCP_PATH_REGEX: &str = "^/api/codex/ps/mcp/?$";
const HOSTED_PLUGIN_RUNTIME_MCP_PATH_REGEX: &str = "^/api/codex/ps/mcp/?$";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "rexux-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__rexux_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str = "mcp__rexux_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__rexux_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__rexux_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__rexux_apps__calendar";
...
pub fn apps_enabled_builder(apps_base_url: impl Into<String>) -> TestRexuxBuilder {
...
pub fn search_capable_apps_builder(apps_base_url: impl Into<String>) -> TestRexuxBuilder {
    let apps_base_url = apps_base_url.into();
    test_rexux()
        .with_auth(RexuxAuth::create_dummy_chatgpt_auth_for_testing())
...
async fn mount_streamable_http_json_rpc_with_startup_control(
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(RexuxAppsJsonRpcResponder {
            connector_name,
            connector_description,
            searchable,
            include_app_only_tool,
...
struct RexuxAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
    include_app_only_tool: bool,
...
impl Respond for RexuxAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let rexux_apps_meta = body.pointer("/params/_meta/_rexux_apps").cloned();
