...
use rexux_app_server_protocol::RemoteControlDisableParams;
use rexux_app_server_protocol::RemoteControlDisableResponse;
use rexux_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<rexux_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_REXUX_HOME: &str = "/tmp/rexux-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "rexux_app_server/1.2.3",
                    "codexHome": TEST_REXUX_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
