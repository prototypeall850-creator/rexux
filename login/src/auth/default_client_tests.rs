...
fn is_first_party_originator_matches_known_values() {
    ...
    assert_eq!(is_first_party_originator("Rexux Something Else"), true);
    assert_eq!(is_first_party_originator("rexux_cli"), false);
...
async fn test_create_client_sets_default_headers() {
    ...
    // User-Agent matches the computed Rexux UA for that originator
    let expected_ua = get_rexux_user_agent();
