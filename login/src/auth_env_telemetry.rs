...
use rexux_otel::AuthEnvTelemetryMetadata;

use crate::REXUX_API_KEY_ENV_VAR;
...
pub struct AuthEnvTelemetry {
    ...
    pub rexux_api_key_env_present: bool,
    pub rexux_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            rexux_api_key_env_present: self.rexux_api_key_env_present,
            rexux_api_key_env_enabled: self.rexux_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    rexux_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        rexux_api_key_env_present: env_var_present(REXUX_API_KEY_ENV_VAR),
        rexux_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*rexux_api_key_env_enabled*/ false);
