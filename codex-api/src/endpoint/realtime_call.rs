...
use rexux_client::RequestTelemetry;
use http::HeaderMap;
...
const MULTIPART_BOUNDARY: &str = "rexux-realtime-call-boundary";
const MULTIPART_CONTENT_TYPE: &str = "multipart/form-data; boundary=rexux-realtime-call-boundary";
...
impl<T: HttpTransport> RealtimeCallClient<T> {
    ...
    pub async fn create_with_session_and_headers(
        ...
        trace!(target: "rexux_api::realtime_websocket::wire", "realtime call request SDP: {sdp}");
