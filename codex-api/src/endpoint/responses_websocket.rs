...
const RESPONSES_WEBSOCKET_TIMING_EVENT_TARGET: &str = "rexux_api::responses_websocket_timing";
...
fn emit_responses_websocket_timing_event(
    ...
    // `RUST_LOG='rexux_api::responses_websocket_timing=trace'`.
    tracing::event!(
    ...
    fn direct_serialization_preserves_websocket_request_payload() {
        let api_request = ResponsesApiRequest {
            ...
            access_programs: Some(
                rexux_protocol::turn_input::CyberAccessProgram::DaybreakBlue.into(),
            ),
