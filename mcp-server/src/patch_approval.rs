...
pub struct PatchApprovalElicitRequestParams {
    ...
    pub rexux_elicitation: String,
    pub rexux_mcp_tool_call_id: String,
    pub rexux_event_id: String,
    pub rexux_call_id: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rexux_reason: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rexux_grant_root: Option<PathBuf>,
    pub rexux_changes: HashMap<PathBuf, FileChange>,
}
...
pub(crate) async fn handle_patch_approval_request(
    ...
    let params = PatchApprovalElicitRequestParams {
        ...
        rexux_mcp_tool_call_id: tool_call_id.clone(),
        rexux_event_id: event_id.clone(),
        rexux_call_id: call_id,
        rexux_reason: reason,
