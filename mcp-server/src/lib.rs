...
mod rexux_tool_config;
mod rexux_tool_runner;
mod exec_approval;
...
pub use crate::rexux_tool_config::RexuxToolCallParam;
pub use crate::rexux_tool_config::RexuxToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "rexux_mcp_server";
...
pub async fn run_main(
    ...
    reject_workload_identity(rexux_login::is_workload_identity_selected())?;
