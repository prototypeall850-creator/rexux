...
use rexux_otel::ORIGINATOR_TAG;
use rexux_otel::bounded_originator_tag_value;
use rexux_state::DbTelemetry;
use rexux_state::DbTelemetryHandle;
use rexux_state::LOG_WRITE_BYTES_METRIC;
use rexux_state::LOG_WRITE_MAX_ENTRY_BYTES_METRIC;
...
pub(crate) fn recorder(metrics: rexux_otel::MetricsClient, originator: &str) -> DbTelemetryHandle {
