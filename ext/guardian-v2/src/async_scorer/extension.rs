...
use rexux_core::context::GuardianReviewEvidence;
...
use rexux_extension_api::ThreadOriginator;
...
use rexux_login::AgentIdentityAuthPolicy;
...
use rexux_protocol::mcp::is_node_repl_backed_tool;
...
use rexux_protocol::protocol::has_full_access;
    ...
    async fn score_tool(&self, input: ToolStartInput<'_>) {
        ...
        tokio::spawn(async move {
            ...
            classification_input.extend([
                "The Rexux agent has requested the following action:\n".to_owned(),
