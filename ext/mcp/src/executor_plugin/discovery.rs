...
use rexux_core_plugins::manifest::parse_plugin_manifest_uri;
use rexux_exec_server::CapabilityRootDiscovery;
use rexux_mcp::parse_executor_plugin_mcp_config;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &rexux_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, rexux_config::McpServerConfig)> {
