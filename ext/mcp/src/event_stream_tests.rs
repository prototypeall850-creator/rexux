...
use rexux_mcp::McpEventNotification;
...
impl Fixture {
    pub async fn new() -> Result<Self> {
        ...
        let auth_value = RexuxAuth::from_external_chatgpt_tokens(
            "header.e30.first",
            "account",
        ...
        let mut server_config = rexux_mcp::hosted_plugin_runtime_mcp_server_config(
        ...
        *bearer_token_env_var = None;
        ...
        let runtime_input = || McpRuntimeInput {
            ...
            mcp_servers: HashMap::from([(
                REXUX_APPS_MCP_SERVER_NAME.into(),
            ...
            rexux_apps_tools_cache: Default::default(),
            tool_catalog_cache: Default::default(),
            rexux_apps_tools_cache_key: rexux_mcp::rexux_apps_tools_cache_key(Some(&auth_value)),
        ...
        assert!(
            runtime
                .latest_wait_for_server_ready(REXUX_APPS_MCP_SERVER_NAME, WAIT)
                .await
        );
        Ok(Self {
            _home: home,
...
pub(super) struct StaticAuth(pub RexuxAuth);
