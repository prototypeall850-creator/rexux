...
use rexux_connectors_extension::ExecutorPluginConnectorProvider;
use rexux_core::config::Config;
use rexux_core_plugins::ExecutorPluginProvider;
use rexux_core_plugins::loader::apply_configured_plugin_mcp_server_policies;
use rexux_core_plugins::loader::configured_plugin_mcp_server_policies;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, rexux_config::McpServerConfig)>,
