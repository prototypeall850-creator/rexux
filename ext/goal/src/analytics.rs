...
use rexux_analytics::RexuxGoalEvent;
use rexux_analytics::GoalEventKind;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &rexux_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(RexuxGoalEvent {
