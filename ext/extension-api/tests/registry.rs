...
use rexux_extension_api::ApprovalAssessment;
use rexux_extension_api::ApprovalReviewContributor;
use rexux_extension_api::ApprovalReviewError;
use rexux_extension_api::ApprovalReviewInput;
...
use rexux_extension_api::ContextualUserFragment;
...
use rexux_extension_api::TokenUsageContributor;
...
use rexux_extension_api::TurnInputContributor;
use rexux_extension_api::TurnItemContributor;
use rexux_extension_api::TurnLifecycleContributor;
use rexux_extension_api::empty_extension_registry;
use rexux_protocol::ThreadId;
use rexux_protocol::approvals::GuardianAssessmentOutcome;
use rexux_protocol::approvals::GuardianRiskLevel;
use rexux_protocol::approvals::GuardianUserAuthorization;
use rexux_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: rexux_protocol::ThreadId::default(),
