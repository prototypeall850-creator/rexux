...
use rexux_thread_store::MAX_QUEUE_ITEMS;
use rexux_thread_store::QueueStore;
use rexux_thread_store::QueuedUserSubmissionRecord;
...
pub enum QueueServiceError {
    ...
    CoreSubmissionError(#[from] RexuxErr),
