...
use rexux_protocol::models::SandboxPermissions;
use rexux_protocol::protocol::GuardianAssessmentOutcome;
use rexux_protocol::protocol::GuardianCommandSource;
use rexux_protocol::protocol::GuardianRiskLevel;
use rexux_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(RexuxAppMentionedEventRequest),
    AppUsed(RexuxAppUsedEventRequest),
    HookRun(RexuxHookRunEventRequest),
    Compaction(Box<RexuxCompactionEventRequest>),
    Goal(Box<RexuxGoalEventRequest>),
    TurnEvent(Box<RexuxTurnEventRequest>),
    TurnSteer(RexuxTurnSteerEventRequest),
    ArtifactOperation(RexuxArtifactOperationEventRequest),
    CommandExecution(RexuxCommandExecutionEventRequest),
    PluginMeasurement(RexuxPluginMeasurementEventRequest),
    FileChange(RexuxFileChangeEventRequest),
    McpToolCall(RexuxMcpToolCallEventRequest),
    DynamicToolCall(RexuxDynamicToolCallEventRequest),
    ControlToolCall(RexuxControlToolCallEventRequest),
    CollabAgentToolCall(RexuxCollabAgentToolCallEventRequest),
    WebSearch(RexuxWebSearchEventRequest),
    ImageGeneration(RexuxImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<RexuxAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(RexuxReviewEventRequest),
    PluginUsed(RexuxPluginUsedEventRequest),
    PluginInstallRequested(RexuxPluginInstallRequestedEventRequest),
    PluginInstalled(RexuxPluginEventRequest),
    PluginUninstalled(RexuxPluginEventRequest),
    PluginEnabled(RexuxPluginEventRequest),
    PluginDisabled(RexuxPluginEventRequest),
    PluginInstallFailed(RexuxPluginInstallFailedEventRequest),
    ExternalAgentConfigImportCompleted(RexuxOnboardingExternalAgentImportCompleteEventRequest),
    ExternalAgentConfigImportFailure(RexuxOnboardingExternalAgentImportFailureEventRequest),
}

#[derive(Serialize)]
pub(crate) struct RexuxArtifactOperationEventParams {
    ...
    pub(crate) runtime: RexuxRuntimeMetadata,
...
#[derive(Serialize)]
pub(crate) struct RexuxArtifactOperationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxArtifactOperationEventParams,
}

pub(crate) fn rexux_artifact_operation_event_request(
    tracking: TrackEventsContext,
    operation: ArtifactOperation,
) -> RexuxArtifactOperationEventRequest {
    RexuxArtifactOperationEventRequest {
        event_type: "rexux_artifact_operation",
        event_params: RexuxArtifactOperationEventParams {
...
#[derive(Serialize)]
pub(crate) struct RexuxAcceptedLineFingerprintsEventParams {
    pub(crate) event_type: &'static str,
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct RexuxAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct RexuxAppServerClientMetadata {
    pub(crate) product_client_id: String,
...
#[derive(Clone, Serialize)]
pub(crate) struct RexuxRuntimeMetadata {
    pub(crate) rexux_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    ...
    pub(crate) app_server_client: RexuxAppServerClientMetadata,
    pub(crate) runtime: RexuxRuntimeMetadata,
...
pub(crate) struct ThreadArchiveEventParams {
    ...
    pub(crate) app_server_client: Option<RexuxAppServerClientMetadata>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) runtime: Option<RexuxRuntimeMetadata>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) thread_source: Option<ThreadSource>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) parent_thread_id: Option<String>,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main Rexux turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct RexuxToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct RexuxReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct RexuxReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct RexuxCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: RexuxToolItemEventBase,
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct RexuxCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxPluginMeasurementEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    pub(crate) item_id: String,
    pub(crate) plugin_id: String,
...
#[derive(Serialize)]
pub(crate) struct RexuxPluginMeasurementEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxPluginMeasurementEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: RexuxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct RexuxFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: RexuxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct RexuxMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: RexuxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct RexuxDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxControlToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: RexuxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct RexuxControlToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxControlToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: RexuxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct RexuxCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: RexuxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct RexuxWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: RexuxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct RexuxImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxAppMetadata {
    pub(crate) connector_id: Option<String>,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct RexuxAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct RexuxAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct RexuxHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) product_client_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct RexuxHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct RexuxCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: RexuxAppServerClientMetadata,
    ...
    pub(crate) rexux_error_kind: Option<RexuxErrKind>,
    pub(crate) rexux_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct RexuxCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxGoalEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: Option<String>,
    pub(crate) app_server_client: RexuxAppServerClientMetadata,
    ...
    pub(crate) goal_status: rexux_state::ThreadGoalStatus,
...
#[derive(Serialize)]
pub(crate) struct RexuxGoalEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxGoalEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) root_turn_id: Option<String>,
    pub(crate) turn_trigger: Option<String>,
    pub(crate) rexux_turn_source: Option<String>,
    ...
    pub(crate) turn_error: Option<RexuxErrorInfo>,
    pub(crate) rexux_error_kind: Option<RexuxErrKind>,
    pub(crate) rexux_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct RexuxTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxTurnSteerEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
...
#[derive(Serialize)]
pub(crate) struct RexuxTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct RexuxPluginMetadata {
    pub(crate) plugin_id: Option<String>,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct RexuxPluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: RexuxPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct RexuxPluginInstallRequestedPluginMetadata {
    pub(crate) plugin_id: String,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct RexuxPluginInstallRequestedMetadata {
    pub(crate) suggestion_id: String,
    pub(crate) plugins: Vec<RexuxPluginInstallRequestedPluginMetadata>,
...
#[derive(Serialize)]
pub(crate) struct RexuxPluginInstallRequestedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxPluginInstallRequestedMetadata,
}

#[derive(Serialize)]
pub(crate) struct RexuxPluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxPluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct RexuxPluginInstallFailedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: RexuxPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct RexuxPluginInstallFailedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxPluginInstallFailedMetadata,
}

#[derive(Serialize)]
pub(crate) struct RexuxOnboardingExternalAgentImportCompleteMetadata {
...
#[derive(Serialize)]
pub(crate) struct RexuxOnboardingExternalAgentImportCompleteEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxOnboardingExternalAgentImportCompleteMetadata,
}

#[derive(Serialize)]
pub(crate) struct RexuxOnboardingExternalAgentImportFailureMetadata {
    pub(crate) import_id: String,
    pub(crate) source: String,
    pub(crate) provider_id: String,
    #[serde(rename = "type")]
...
#[derive(Serialize)]
pub(crate) struct RexuxOnboardingExternalAgentImportFailureEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxOnboardingExternalAgentImportFailureMetadata,
}

#[derive(Serialize)]
pub(crate) struct RexuxPluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: RexuxPluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "rexux_plugin_installed",
        PluginState::Uninstalled => "rexux_plugin_uninstalled",
        PluginState::Enabled => "rexux_plugin_enabled",
        PluginState::Disabled => "rexux_plugin_disabled",
    }
}

pub(crate) fn rexux_app_metadata(
    tracking: &TrackEventsContext,
    app: AppInvocation,
) -> RexuxAppMetadata {
    RexuxAppMetadata {
...
pub(crate) fn rexux_plugin_metadata(plugin: PluginTelemetryMetadata) -> RexuxPluginMetadata {
    rexux_plugin_metadata_with_product_client_id(plugin, originator().value)
}

fn rexux_plugin_metadata_with_product_client_id(
...
pub(crate) fn rexux_plugin_install_requested_metadata(
    tracking: &TrackEventsContext,
    request: PluginInstallRequested,
) -> RexuxPluginInstallRequestedMetadata {
    RexuxPluginInstallRequestedMetadata {
        suggestion_id: request.suggestion_id,
        plugins: request
            .plugins
            .into_iter()
            .map(|plugin| RexuxPluginInstallRequestedPluginMetadata {
...
pub(crate) fn rexux_compaction_event_params(
    input: RexuxCompactionEvent,
    session_id: String,
    ...
    RexuxCompactionEventParams {
        ...
        status: input.status,
        rexux_error_kind: input.rexux_error_kind,
        rexux_error_http_status_code: input.rexux_error_http_status_code,
...
pub(crate) fn rexux_goal_event_params(
    input: RexuxGoalEvent,
    session_id: String,
    app_server_client: RexuxAppServerClientMetadata,
    runtime: RexuxRuntimeMetadata,
    thread_source: Option<ThreadSource>,
...
pub(crate) fn rexux_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> RexuxPluginUsedMetadata {
    let mcp_server_names = plugin
        .capability_summary
        .as_ref()
        .map(|summary| summary.mcp_server_names.clone());
    RexuxPluginUsedMetadata {
        plugin: rexux_plugin_metadata_with_product_client_id(
            plugin,
...
pub(crate) fn rexux_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> RexuxHookRunMetadata {
    RexuxHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        product_client_id: Some(tracking.product_client_id.clone()),
...
pub(crate) fn current_runtime_metadata() -> RexuxRuntimeMetadata {
    let os_info = os_info::get();
    RexuxRuntimeMetadata {
        rexux_rs_version: env!("CARGO_PKG_VERSION").to_string(),
