...
use rexux_rollout::first_rollout_content_match_snippet;
use rexux_rollout::parse_cursor;
use rexux_rollout::search_rollout_matches;
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = rexux_rollout::plain_rollout_path(item.path.as_path());
