# rexux-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Rexux did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Rexux on it. Feel free to update the documentation as you
modify the code
...
```rust
use rexux_utils_stream_parser::CitationStreamParser;
use rexux_utils_stream_parser::StreamTextParser;
...
```rust
use rexux_utils_stream_parser::CitationStreamParser;
use rexux_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), rexux_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use rexux_utils_stream_parser::InlineHiddenTagParser;
use rexux_utils_stream_parser::InlineTagSpec;
use rexux_utils_stream_parser::StreamTextParser;
