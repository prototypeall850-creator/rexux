//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across Rexux
//! crates.
...
pub use rexux_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
...
const PLUGIN_METADATA_DIR: &str = ".rexux-plugin";
