...
"#,
    ...
    assert_eq!(
        ...
        Some(FeatureToml::Config(crate::GuardianV2ConfigToml {
            ...
            reasoning_effort: Some(rexux_protocol::openai_models::ReasoningEffort::Minimal),
...
#[test]
fn rexux_hooks_is_legacy_alias_for_hooks() {
    assert_eq!(feature_for_key("hooks"), Some(Feature::RexuxHooks));
    assert_eq!(feature_for_key("rexux_hooks"), Some(Feature::RexuxHooks));
}
