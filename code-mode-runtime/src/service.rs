...
use rexux_code_mode_protocol::CodeModeSession;
use rexux_code_mode_protocol::CodeModeSessionCellExecutionLimits;
use rexux_code_mode_protocol::CodeModeSessionDelegate;
use rexux_code_mode_protocol::CodeModeSessionResultFuture;
use rexux_code_mode_protocol::CodeModeToolKind;
use rexux_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use rexux_code_mode_protocol::ExecuteRequest;
use rexux_code_mode_protocol::ExecuteToPendingOutcome;
use rexux_code_mode_protocol::FunctionCallOutputContentItem;
use rexux_code_mode_protocol::ImageDetail;
use rexux_code_mode_protocol::NoopCodeModeSessionDelegate;
use rexux_code_mode_protocol::RuntimeResponse;
use rexux_code_mode_protocol::StartedCell;
use rexux_code_mode_protocol::WaitOutcome;
use rexux_code_mode_protocol::WaitRequest;
use rexux_code_mode_protocol::WaitToPendingOutcome;
use rexux_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: rexux_protocol::ToolName {
