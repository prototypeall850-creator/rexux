pub use rexux_backend_openapi_models::models::ConfigBundleResponse;
pub use rexux_backend_openapi_models::models::CreditStatusDetails;
pub use rexux_backend_openapi_models::models::DeliveredConfigToml;
pub use rexux_backend_openapi_models::models::DeliveredManagedLayers;
pub use rexux_backend_openapi_models::models::DeliveredRequirementsToml;
pub use rexux_backend_openapi_models::models::DeliveredTomlFragment;
pub use rexux_backend_openapi_models::models::PaginatedListTaskListItem;
pub use rexux_backend_openapi_models::models::PlanType;
pub use rexux_backend_openapi_models::models::RateLimitReachedKind;
pub use rexux_backend_openapi_models::models::RateLimitStatusDetails;
pub use rexux_backend_openapi_models::models::RateLimitStatusPayload;
pub use rexux_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use rexux_backend_openapi_models::models::SpendControlLimitDetails;
pub use rexux_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct RexuxWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<RexuxWorkspaceMessage>,
}

/// Authenticated Rexux user settings used by CLI runtime policy.
#[derive(Clone, Copy, Debug, Default, Deserialize, PartialEq, Eq)]
pub struct RexuxUserSettingsResponse {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct RexuxWorkspaceMessage {
    pub message_id: String,
    pub message_type: RexuxWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum RexuxWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: RexuxWorkspaceMessagesResponse = serde_json::from_value(serde_json::json!({
            "messages": [
                {
        ...
        assert_eq!(
            response,
            RexuxWorkspaceMessagesResponse {
                messages: vec![
                    RexuxWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: RexuxWorkspaceMessageType::Headline,
                    ...
                    RexuxWorkspaceMessage {
                        ...
                        message_type: RexuxWorkspaceMessageType::Announcement,
                    ...
                    RexuxWorkspaceMessage {
                        ...
                        message_type: RexuxWorkspaceMessageType::Unknown,
