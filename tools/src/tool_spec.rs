...
use rexux_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use rexux_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
use rexux_protocol::config_types::WebSearchUserLocationType;
use serde::Serialize;
