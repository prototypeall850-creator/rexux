...
/// Serializes tests that mutate process-wide REXUX_HOME.
///
...
pub(crate) struct TempRexuxHome {
...
impl TempRexuxHome {
    pub(crate) fn new() -> Self {
        ...
        let dir = tempdir().expect("create REXUX_HOME temp dir");
        unsafe {
            std::env::set_var("REXUX_HOME", dir.path());
        }
        Self {
            _guard: guard,
            _dir: dir,
