...
//! preserve the legacy `rexux_login::default_client::create_client_without_request_logging()`
...
//! startup-sync request helpers remain responsible for applying the standard Rexux headers.
...
use rexux_http_client::RequestBuilder;
