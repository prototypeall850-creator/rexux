...
pub type LoadedPlugin = rexux_plugin::LoadedPlugin<rexux_config::McpServerConfig>;
pub type PluginLoadOutcome = rexux_plugin::PluginLoadOutcome<rexux_config::McpServerConfig>;
