...
use rexux_app_server_protocol::AccountRateLimitsUpdatedNotification;
use rexux_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use rexux_app_server_protocol::AuthRecoveryNotification;
use rexux_app_server_protocol::RexuxErrorInfo as V2RexuxErrorInfo;
use rexux_app_server_protocol::CommandAction as V2ParsedCommand;
use rexux_app_server_protocol::CommandExecutionApprovalDecision;
use rexux_app_server_protocol::CommandExecutionPresentation;
...
use rexux_app_server_protocol::DynamicToolCallParams;
use rexux_app_server_protocol::EnvironmentConnectionNotification;
use rexux_app_server_protocol::ErrorNotification;
use rexux_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use rexux_app_server_protocol::FileChangeApprovalDecision;
use rexux_app_server_protocol::FileChangeRequestApprovalParams;
use rexux_app_server_protocol::FileChangeRequestApprovalResponse;
use rexux_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use rexux_app_server_protocol::GuardianWarningNotification;
use rexux_app_server_protocol::HookCompletedNotification;
use rexux_app_server_protocol::HookStartedNotification;
use rexux_app_server_protocol::ItemCompletedNotification;
use rexux_app_server_protocol::ItemStartedNotification;
use rexux_app_server_protocol::McpServerElicitationAction;
use rexux_app_server_protocol::McpServerElicitationRequestParams;
use rexux_app_server_protocol::McpServerElicitationRequestResponse;
use rexux_app_server_protocol::McpServerStartupState;
use rexux_app_server_protocol::McpServerStatusUpdatedNotification;
use rexux_app_server_protocol::ModelReroutedNotification;
use rexux_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use rexux_app_server_protocol::ModelVerificationNotification;
use rexux_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use rexux_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use rexux_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use rexux_app_server_protocol::PermissionsRequestApprovalParams;
use rexux_app_server_protocol::PermissionsRequestApprovalResponse;
use rexux_app_server_protocol::RawResponseCompletedNotification;
use rexux_app_server_protocol::RawResponseItemCompletedNotification;
...
use rexux_app_server_protocol::StrictReviewRequiredNotification;
use rexux_app_server_protocol::ThreadGoalUpdatedNotification;
use rexux_app_server_protocol::ThreadItem;
use rexux_app_server_protocol::ThreadRealtimeClosedNotification;
use rexux_app_server_protocol::ThreadRealtimeErrorNotification;
use rexux_app_server_protocol::ThreadRealtimeItemAddedNotification;
use rexux_app_server_protocol::ThreadRealtimeItemCompletedNotification;
use rexux_app_server_protocol::ThreadRealtimeItemStartedNotification;
use rexux_app_server_protocol::ThreadRealtimeItemTranscriptDeltaNotification;
use rexux_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use rexux_app_server_protocol::ThreadRealtimeSdpNotification;
use rexux_app_server_protocol::ThreadRealtimeStartedNotification;
use rexux_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use rexux_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use rexux_app_server_protocol::ThreadRollbackResponse;
use rexux_app_server_protocol::ThreadSettingsUpdatedNotification;
use rexux_app_server_protocol::ThreadStatus;
use rexux_app_server_protocol::ThreadTokenUsage;
use rexux_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use rexux_app_server_protocol::ToolRequestUserInputOption;
use rexux_app_server_protocol::ToolRequestUserInputParams;
use rexux_app_server_protocol::ToolRequestUserInputQuestion;
use rexux_app_server_protocol::ToolRequestUserInputResponse;
...
use rexux_app_server_protocol::TurnModerationMetadataNotification;
use rexux_app_server_protocol::TurnPlanStep;
use rexux_app_server_protocol::TurnPlanUpdatedNotification;
use rexux_app_server_protocol::TurnStartedNotification;
use rexux_app_server_protocol::TurnStatus;
use rexux_app_server_protocol::WarningNotification;
use rexux_app_server_protocol::build_item_from_guardian_event;
use rexux_app_server_protocol::guardian_auto_approval_review_notification;
use rexux_app_server_protocol::item_event_to_server_notification;
use rexux_core::RexuxThread;
use rexux_core::ThreadManager;
use rexux_features::Feature;
use rexux_guardian_v2::StrictReviewReason;
use rexux_protocol::ThreadId;
use rexux_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use rexux_protocol::items::TurnItem as CoreTurnItem;
use rexux_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use rexux_protocol::plan_tool::UpdatePlanArgs;
use rexux_protocol::protocol::RexuxErrorInfo as CoreRexuxErrorInfo;
use rexux_protocol::protocol::Event;
use rexux_protocol::protocol::EventMsg;
use rexux_protocol::protocol::ExecApprovalRequestEvent;
use rexux_protocol::protocol::Op;
use rexux_protocol::protocol::RealtimeEvent;
use rexux_protocol::protocol::ReviewDecision;
...
use rexux_protocol::protocol::TurnDiffEvent;
...
use rexux_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use rexux_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use rexux_shell_command::parse_command::shlex_join;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                rexux_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                rexux_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                rexux_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                rexux_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == rexux_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                rexux_protocol::protocol::GuardianAssessmentStatus::Denied
                | rexux_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                rexux_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                rexux_protocol::protocol::GuardianAssessmentStatus::InProgress
                | rexux_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: rexux_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let rexux_error_info = ev.rexux_error_info.clone();
            ...
            if matches!(
                rexux_error_info,
                Some(CoreRexuxErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                ...
                message: ev.message,
                rexux_error_info: ev.rexux_error_info.map(V2RexuxErrorInfo::from),
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: rexux_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: rexux_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<RexuxThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: rexux_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            rexux_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use anyhow::bail;
    use chrono::Utc;
    use rexux_app_server_protocol::AutoReviewDecisionSource;
    ...
    use rexux_app_server_protocol::TurnPlanStepStatus;
    use rexux_login::RexuxAuth;
    use rexux_protocol::AgentPath;
    use rexux_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use rexux_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use rexux_protocol::items::DynamicToolCallItem;
    use rexux_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use rexux_protocol::items::SubAgentActivityItem;
    use rexux_protocol::items::TurnItem as CoreTurnItem;
    use rexux_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use rexux_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    use rexux_protocol::models::PermissionProfile;
    use rexux_protocol::plan_tool::PlanItemArg;
    use rexux_protocol::plan_tool::StepStatus;
    use rexux_protocol::protocol::AgentMessageEvent;
    use rexux_protocol::protocol::AskForApproval;
    use rexux_protocol::protocol::AuthRecoveryEvent;
    use rexux_protocol::protocol::CreditsSnapshot;
    use rexux_protocol::protocol::EventMsg;
    use rexux_protocol::protocol::GuardianAssessmentEvent;
    use rexux_protocol::protocol::GuardianAssessmentStatus;
    use rexux_protocol::protocol::ItemCompletedEvent;
    use rexux_protocol::protocol::ItemStartedEvent;
    ...
    use rexux_thread_store::StoredThreadHistory;
    use rexux_utils_absolute_path::AbsolutePathBuf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: rexux_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(rexux_protocol::protocol::GuardianRiskLevel::Low),
                Some(rexux_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(rexux_protocol::protocol::GuardianRiskLevel::High),
                Some(rexux_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(rexux_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = rexux_protocol::protocol::GuardianAssessmentAction::Command {
            source: rexux_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: rexux_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: rexux_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(rexux_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(rexux_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    rexux_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(rexux_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(rexux_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = rexux_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: rexux_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: rexux_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            rexux_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&rexux_home).await;
        let thread_manager = Arc::new(
            rexux_core::test_support::thread_manager_with_models_provider_and_home(
                RexuxAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.rexux_home.to_path_buf(),
                Arc::new(rexux_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let rexux_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(rexux_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                rexux_error_info: Some(V2RexuxErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(rexux_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(rexux_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(rexux_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let rexux_core::NewThread {
            ...
            .start_thread(rexux_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: rexux_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                rexux_error_info: Some(V2RexuxErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                rexux_error_info: Some(V2RexuxErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
