    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: rexux_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        rexux_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                rexux_app_server_protocol::AdditionalFileSystemPermissions {
