...
use rexux_app_server_protocol::CommandMigration;
...
use rexux_app_server_protocol::ExternalAgentConfigImportHistory;
...
use rexux_app_server_protocol::ExternalAgentDetectedConnectorCandidate;
use rexux_app_server_protocol::ExternalAgentDetectedConnectorSource;
use rexux_app_server_protocol::HookMigration;
use rexux_app_server_protocol::JSONRPCErrorError;
use rexux_app_server_protocol::McpServerMigration;
use rexux_app_server_protocol::MigrationDetails;
use rexux_app_server_protocol::PluginsMigration;
use rexux_app_server_protocol::SkillMigration;
use rexux_app_server_protocol::SubagentMigration;
use rexux_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use rexux_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use rexux_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use rexux_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use rexux_external_agent_migration::ExternalAgentConfigImportSuccess;
use rexux_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use rexux_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use rexux_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use rexux_external_agent_migration::NamedMigration;
use rexux_external_agent_migration::PluginsMigration as CorePluginsMigration;
use rexux_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| rexux_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: rexux_state::ExternalAgentConfigImportHistoryRecord,
