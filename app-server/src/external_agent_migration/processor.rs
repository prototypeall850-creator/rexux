...
use rexux_analytics::ExternalAgentConfigImportCompletedInput;
use rexux_analytics::ExternalAgentConfigImportFailureInput;
...
use rexux_app_server_protocol::ExternalAgentConfigImportHistoryRecordParams;
use rexux_app_server_protocol::ExternalAgentConfigImportHistoryRecordResponse;
use rexux_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use rexux_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
...
use rexux_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use rexux_external_agent_migration::DetectedConnectorCandidate;
use rexux_external_agent_migration::ExternalAgentConfigDetectOptions;
use rexux_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use rexux_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use rexux_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use rexux_external_agent_migration::ExternalAgentConfigService;
use rexux_external_agent_migration::ExternalAgentSessionImportLimits;
use rexux_external_agent_migration::PluginImportOutcome;
use rexux_external_agent_migration::record_import_error;
use rexux_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use rexux_external_agent_migration::sessions::read_imported_connector_candidates;
use rexux_external_agent_migration::sessions::record_detected_session_connectors;
use rexux_features::Feature;
use rexux_rollout::StateDbHandle;
use rexux_state::ExternalAgentConfigImportFailureRecord;
use rexux_state::ExternalAgentConfigImportSuccessRecord;
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn detect(
        ...
        record_detected_session_connectors(
            self.migration_service.rexux_home(),
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors = read_imported_connector_candidates(self.migration_service.rexux_home())
            .map_err(|err| {
                internal_error(format!(
