...
pub(super) async fn wait_for_thread_shutdown(thread: &Arc<RexuxThread>) -> ThreadShutdownResult {
...
fn merge_active_turn_into_page(
    page: &mut rexux_app_server_protocol::TurnsPage,
    mut active_turn: Turn,
    params: &rexux_app_server_protocol::ThreadResumeInitialTurnsPageParams,
) {
