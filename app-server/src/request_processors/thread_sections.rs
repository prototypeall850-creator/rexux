...
use rexux_app_server_protocol::ThreadSectionCreateResponse;
use rexux_app_server_protocol::ThreadSectionDeleteParams;
use rexux_app_server_protocol::ThreadSectionDeleteResponse;
...
use rexux_app_server_protocol::ThreadSectionUpdateResponse;
use rexux_state::PINNED_THREAD_SECTION_ID;
use rexux_thread_store::CreateThreadSectionParams as StoreCreateThreadSectionParams;
use rexux_thread_store::DeleteThreadSectionParams as StoreDeleteThreadSectionParams;
use rexux_thread_store::ListThreadSectionsParams as StoreListThreadSectionsParams;
use rexux_thread_store::RenameThreadSectionParams as StoreRenameThreadSectionParams;
use rexux_thread_store::StoredThreadSection;
...
fn state_thread_section_appearance(
    appearance: ThreadSectionAppearance,
) -> rexux_state::ThreadSectionAppearance {
    rexux_state::ThreadSectionAppearance {
        icon: appearance.icon,
        color: appearance.color,
    }
