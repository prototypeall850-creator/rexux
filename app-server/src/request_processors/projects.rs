...
use rexux_app_server_protocol::Project;
use rexux_app_server_protocol::ProjectChangeType;
use rexux_app_server_protocol::ProjectChangedNotification;
use rexux_app_server_protocol::ProjectCreateParams;
use rexux_app_server_protocol::ProjectCreateResponse;
use rexux_app_server_protocol::ProjectDeleteParams;
use rexux_app_server_protocol::ProjectDeleteResponse;
use rexux_app_server_protocol::ProjectImportParams;
use rexux_app_server_protocol::ProjectImportResponse;
use rexux_app_server_protocol::ProjectListParams;
use rexux_app_server_protocol::ProjectListResponse;
use rexux_app_server_protocol::ProjectMoveParams;
use rexux_app_server_protocol::ProjectMoveResponse;
use rexux_app_server_protocol::ProjectReadParams;
use rexux_app_server_protocol::ProjectReadResponse;
use rexux_app_server_protocol::ProjectRoot;
use rexux_app_server_protocol::ProjectSortKey;
use rexux_app_server_protocol::ProjectUpdateParams;
use rexux_app_server_protocol::ProjectUpdateResponse;
...
use rexux_thread_store::CreateProjectParams as StoreCreateProjectParams;
use rexux_thread_store::ListProjectsParams as StoreListProjectsParams;
use rexux_thread_store::MoveProjectParams as StoreMoveProjectParams;
use rexux_thread_store::ProjectMoveOutcome;
use rexux_thread_store::ProjectSortKey as StoreProjectSortKey;
use rexux_thread_store::SortDirection as StoreSortDirection;
use rexux_thread_store::StoredProject;
use rexux_thread_store::StoredProjectRoot;
use rexux_thread_store::ThreadStore;
use rexux_thread_store::ThreadStoreError;
use rexux_thread_store::UpdateProjectParams as StoreUpdateProjectParams;
...
fn validate_roots(roots: Vec<ProjectRoot>) -> Result<Vec<StoredProjectRoot>, JSONRPCErrorError> {
    ...
    roots
        .into_iter()
        .map(|root| {
            let path = rexux_utils_absolute_path::AbsolutePathBuf::from_absolute_path_checked(
...
fn api_project(project: StoredProject) -> Result<Project, JSONRPCErrorError> {
    Ok(Project {
        ...
        roots: project
            ...
            .map(|root| {
                Ok(ProjectRoot {
                    path: rexux_utils_absolute_path::AbsolutePathBuf::from_absolute_path(root.path)
                        .map_err(|error| {
