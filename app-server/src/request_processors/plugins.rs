...
use rexux_analytics::PluginInstallSource;
use rexux_app_server_protocol::PluginAvailability;
use rexux_app_server_protocol::PluginSharePrincipalRole;
use rexux_app_server_protocol::PluginShareTargetRole;
use rexux_config::types::McpServerConfig;
use rexux_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use rexux_core_plugins::PluginListBackgroundTaskOptions;
use rexux_core_plugins::PluginMarketplaceContext;
use rexux_core_plugins::RemotePluginInstallRequest;
use rexux_core_plugins::RemotePluginOperationError;
use rexux_core_plugins::RemotePluginOperationErrorKind;
use rexux_core_plugins::is_openai_curated_marketplace_name;
use rexux_core_plugins::loader::load_configured_plugin_mcp_servers;
use rexux_core_plugins::manifest::is_agent_plugin_manifest;
use rexux_core_plugins::remote::REMOTE_CREATED_BY_ME_MARKETPLACE_NAME;
use rexux_core_plugins::remote::REMOTE_GLOBAL_MARKETPLACE_NAME;
use rexux_core_plugins::remote::REMOTE_WORKSPACE_MARKETPLACE_NAME;
use rexux_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_MARKETPLACE_NAME;
use rexux_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_PRIVATE_MARKETPLACE_NAME;
use rexux_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_UNLISTED_MARKETPLACE_NAME;
use rexux_core_plugins::remote::RemoteAppTemplateUnavailableReason;
use rexux_core_plugins::remote::RemotePluginCatalogCacheMode;
use rexux_core_plugins::remote::RemotePluginScope;
use rexux_core_plugins::remote::is_valid_remote_plugin_id;
use rexux_core_plugins::remote::validate_remote_plugin_id;
use rexux_core_plugins::remote_bundle::RemotePluginBundleInstallError;
use rexux_mcp::McpOAuthLoginSupport;
use rexux_mcp::McpRuntimeContext;
use rexux_mcp::oauth_login_support;
use rexux_mcp::resolve_oauth_callback;
use rexux_mcp::should_retry_without_scopes;
use rexux_plugin::PluginId;
use rexux_plugin::PluginTelemetryMetadata;
use rexux_protocol::auth::AuthMode as DomainAuthMode;
use rexux_rmcp_client::McpOAuthClientRegistration;
use rexux_rmcp_client::OAuthDiscoveryTimeout;
use rexux_rmcp_client::StreamableHttpRedirectMode;
use rexux_rmcp_client::perform_oauth_login_silent;
...
pub(crate) struct PluginRequestProcessor {
    ...
    on_effective_plugins_changed:
        Arc<dyn Fn(rexux_core_plugins::EffectivePluginsChange) + Send + Sync>,
}

fn plugin_skills_to_info(
    skills: &[rexux_skills::SkillMetadata],
    ...
    skills
        ...
        .map(|skill| SkillSummary {
            ...
            interface: skill.interface.clone().map(|interface| {
                rexux_app_server_protocol::SkillInterface {
...
fn load_shared_plugin_ids_by_local_path(
    ...
    rexux_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
...
fn convert_configured_marketplace_plugin_to_plugin_summary(
    plugin: rexux_core_plugins::ConfiguredMarketplacePlugin,
    shared_plugin_ids_by_local_path: &std::collections::BTreeMap<AbsolutePathBuf, String>,
) -> PluginSummary {
...
) -> rexux_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            rexux_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            rexux_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            rexux_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> rexux_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Listed => {
            rexux_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Listed
        }
        PluginShareUpdateDiscoverability::Unlisted => {
            rexux_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            rexux_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> rexux_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            rexux_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            rexux_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: rexux_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        rexux_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        rexux_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        rexux_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<rexux_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| rexux_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        rexux_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        rexux_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        rexux_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: rexux_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    pub(crate) fn new(
        ...
        on_effective_plugins_changed: Arc<
            dyn Fn(rexux_core_plugins::EffectivePluginsChange) + Send + Sync,
        >,
    ) -> Self {
        Self {
            auth_manager,
    ...
    async fn plugin_list_response(
        ...
        let auth_mode = auth.as_ref().map(RexuxAuth::api_auth_mode);
        if include_local
            && force_refetch
            && plugins_manager
        ...
        let use_remote_global_catalog =
            include_global_remote && auth_mode.is_some_and(DomainAuthMode::uses_rexux_backend);
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<rexux_app_server_protocol::MarketplaceLoadErrorInfo>,
                        Vec<rexux_core_plugins::ConfiguredMarketplace>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        .errors
                        .into_iter()
                        .map(|err| rexux_app_server_protocol::MarketplaceLoadErrorInfo {
        ...
        if include_vertical && !config.features.enabled(Feature::RemotePlugin) {
            match rexux_core_plugins::remote::fetch_openai_curated_remote_collection_marketplace(
        ...
        if !remote_sources.is_empty() {
            match rexux_core_plugins::remote::fetch_remote_marketplaces(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_sources,
                /*catalog_cache_root*/ Some(config.rexux_home.as_path()),
    ...
    async fn plugin_installed_response(
        ...
        let use_remote_global_catalog = context.remote_plugins_enabled()
            && auth_mode.is_some_and(DomainAuthMode::uses_rexux_backend);
    ...
    async fn load_local_installed_and_suggested_plugins(
        &self,
        plugins_manager: Arc<rexux_core_plugins::PluginsManager>,
        config: &Config,
    ...
    async fn load_remote_installed_plugins(
        &self,
        plugins_manager: Arc<rexux_core_plugins::PluginsManager>,
        plugins_input: &rexux_core_plugins::PluginsConfigInput,
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        let remote_plugin_service_config = remote_plugin_service_config(&config);
                        match rexux_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| rexux_app_server_protocol::PluginHookSummary {
                            key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail = rexux_core_plugins::remote::fetch_remote_plugin_detail(
                    &remote_plugin_service_config,
                    auth.as_ref(),
                    &remote_marketplace_name,
                    &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(rexux_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
    ...
    async fn plugin_skill_read_response(
        ...
        let auth = self.auth_manager.auth().await;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_skill_detail = rexux_core_plugins::remote::fetch_remote_plugin_skill_detail(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_share_save_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let access_policy = rexux_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = rexux_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.rexux_home.as_path(),
            &plugin_path,
        ...
        rexux_core_plugins::remote::invalidate_cached_remote_plugin_catalog_scopes(
            config.rexux_home.as_path(),
            &remote_plugin_service_config,
            auth.as_ref(),
    ...
    async fn plugin_share_update_targets_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = rexux_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let (config, auth) = self.load_plugin_share_config_and_auth().await?;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let data = rexux_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.rexux_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = rexux_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.rexux_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        rexux_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.rexux_home.as_path(),
            &remote_plugin_id,
    ...
    async fn load_plugin_share_config_and_auth(
        &self,
    ) -> Result<(Config, Option<RexuxAuth>), JSONRPCErrorError> {
        let config = self.load_latest_config(/*fallback_cwd*/ None).await?;
        if !config.features.enabled(Feature::Plugins) {
    ...
    async fn plugin_install_response(
        ...
        let plugin_mcp_servers = load_configured_plugin_mcp_servers(
            ...
            auth.as_ref().map(RexuxAuth::auth_mode),
            &result.plugin_id,
    ...
    async fn remote_plugin_install_response(
        ...
        let is_chatgpt_auth = auth.as_ref().is_some_and(RexuxAuth::is_chatgpt_auth);
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        auth: Option<&RexuxAuth>,
        plugin_id: &str,
        plugin_app_declarations: &[rexux_plugin::AppDeclaration],
    ) -> Vec<AppSummary> {
        if plugin_app_declarations.is_empty()
            || !config
                .features
                .apps_enabled_for_auth(auth.is_some_and(RexuxAuth::is_chatgpt_auth))
        {
            return Vec::new();
        }

        let plugin_apps =
            rexux_plugin::app_connector_ids_from_declarations(plugin_app_declarations);
        ...
        let (accessible_connectors, rexux_apps_ready) = match accessible_connectors_result {
            Ok(status) => (status.connectors, status.rexux_apps_ready),
            Err(err) => {
                warn!(
                    plugin = plugin_id,
        ...
        if !rexux_apps_ready {
            warn!(
                plugin = plugin_id,
                "rexux_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
            );
            return Vec::new();
        }
    ...
    async fn plugin_uninstall_response(
        ...
        if rexux_plugin::PluginId::parse(&plugin_id).is_err()
...
async fn load_plugin_app_summaries(
    config: &Config,
    auth: Option<&RexuxAuth>,
    plugin_apps: &[rexux_plugin::AppConnectorId],
    ...
    if let Some(auth) = auth.filter(|auth| {
        config
            .features
            .apps_enabled_for_auth(auth.uses_rexux_backend())
    }) {
        metadata_by_id.extend(
            rexux_connectors::ConnectorMetadataStore::new(
                config.chatgpt_base_url.clone(),
                auth.get_account_id(),
    ...
    app_ids
        ...
        .map(|app_id| {
            ...
            AppSummary {
                install_url: Some(rexux_connectors::metadata::connector_install_url(
                    &name, &app_id,
                )),
                id: app_id,
                name,
...
fn plugin_app_category_by_id_from_value(value: &serde_json::Value) -> HashMap<String, String> {
    rexux_core_plugins::loader::plugin_app_declarations_from_value(value)
        .into_iter()
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: rexux_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: rexux_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
