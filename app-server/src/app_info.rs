use rexux_app_server_protocol::AppBranding as ApiAppBranding;
use rexux_app_server_protocol::AppInfo as ApiAppInfo;
use rexux_app_server_protocol::AppMetadata as ApiAppMetadata;
use rexux_app_server_protocol::AppReview as ApiAppReview;
use rexux_app_server_protocol::AppScreenshot as ApiAppScreenshot;
use rexux_app_server_protocol::AppToolSummary as ApiAppToolSummary;
use rexux_app_server_protocol::ConnectorMetadata as ApiConnectorMetadata;
use rexux_connectors::AppBranding;
use rexux_connectors::AppInfo;
use rexux_connectors::AppMetadata;
use rexux_connectors::AppReview;
use rexux_connectors::AppScreenshot;
...
/// Converts connector-domain app metadata owned by `rexux-connectors` into the app-server wire
/// type owned by `rexux-app-server-protocol`.
///
