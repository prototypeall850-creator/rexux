...
use rexux_app_server_protocol::Model;
use rexux_app_server_protocol::ModelListParams;
use rexux_app_server_protocol::ModelListResponse;
use rexux_app_server_protocol::ModelServiceTier;
use rexux_app_server_protocol::ModelUpgradeInfo;
use rexux_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        rexux_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
